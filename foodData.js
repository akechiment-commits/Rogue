...
export const COOKED_FOODS_SAVORY = [
  ...
  "ダールマカニ","ゴア風フィッシュカレー","ポハ","パーラク","コルカタロール",
  ...
  /* ジョージア */
  "グルジア風肉饅頭","ミサール","アジャプサンダリ","チャフカパリ","ロビアニ","ハシ","ムツヴァディ",
  /* 中央アジア */
...
export const COOKED_FOODS_SWEET = [
  ...
  "モロッコ風アーモンドパスティリャ（甘）","チュニジア風デーツ菓子","エジプト風アシュラ","ボフロット",
  /* インド系スイーツ */
...
function _buildFoodCatMap() {
  ...
  const _catSavory = [
    ...
    { cat: "russian",         items: S.slice(S.indexOf("ピロシキ"), S.indexOf("グルジア風肉饅頭")) },
    { cat: "georgian",        items: S.slice(S.indexOf("グルジア風肉饅頭"), S.indexOf("プロフ")) },
