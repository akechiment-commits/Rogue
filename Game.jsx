...
import {
  ITEMS, WATER_BOTTLE, SPELLBOOKS, SPELLS, WANDS, POTS, TRAPS,
  itemPrice, genFood, makeArrow, addArrowsInv, addStonesInv,
  wallBreakDrop, makePot, placeItemAt,
  setPitfallBag, clearPitfallBag, applyWandEffect,
  monsterFireLightning, checkShopTheft, applySpellEffect, applyLightningToInventory,
  WEAPON_ABILITIES, ARMOR_ABILITIES, inMagicSealRoom,
  monsterDrop, killMonster, getIdentKey, generateFakeNames,
  hasCursedExplosionPentacle, randPotCapacity,
} from "./items.js";
