...
function monTraits(m) {
  ...
  st.dodgemole = '通常の投擲物・矢・杖の光弾・魔法・巻物の効果・矢罠・水鉄砲・直線型のLv1ブレスを潜ってかわし、弾道を後ろへ通す。Lv2以降の追尾型ブレス、爆弾矢の爆風、石・魔法の石・割れた薬の飛沫・這いずり爆弾・魚雷・追尾弾は命中する。移動先の罠は効果を発揮せず消滅する（封印中は能力無効）';
