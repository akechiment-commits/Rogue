...
const GUIDE_DESC_OVERRIDES = {
  ...
  "魚雷": "特殊飛び道具（基礎攻撃力64）。装備して射撃する場合は1個ずつ、インベントリから「投げる」場合は束全体を1発にまとめて投げ、束の個数を攻撃力へ加算して全個数を消費する。発射後はプレイヤーの行動終了ごとに1マス進む。水タイルの上を進み、水中の敵に触れると必中で大ダメージを与えて消滅する。敵が同じターンに移動して軌道と交差した場合も命中する。敵に当たらず水の外へ出た場合は、そのマスで魚雷アイテムとして残る。地上へ向けて撃った場合も最初の地上マスに残る。壁に当たると消滅する。遠投中や下手投げでは消滅する。",
