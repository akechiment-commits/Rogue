...
const GUIDE_DESC_OVERRIDES = {
  ...
  "油まみれの罠": "踏むと100ターン油まみれ（statusDuration 基準・油壺と同値）。炎・爆発ダメージ2倍。\n敵が踏んでも同様（ボス・店主も有効）。",
...
const statusData = [
  ...
  ['金縛り（paralyzeTurns）', '10', '10（ボス有限／通常は被ダメ解除）', '×2／強金縛り（2回アクション）', '移動不可・通常回避不可（絶対回避は有効）', '行動不可・通常回避不可（絶対回避は有効）', '金縛りの薬・杖・巻物'],
  ['加速（hasteTurns）', '10', '10', '—', '速度×2（2回行動）', '速度UP', '鈍足の杖（呪い）等'],
  ['暗闇（darknessTurns）', '20', '50', '×2／敵は永続', '視界1マス。巻物・魔法書が読めない', '認識不可・直進移動', '暗闇の薬・杖・罠'],
  ['幻惑（bewitchedTurns / fleeingTurns）', '50', '50', '×2／敵は永続', '周囲の見た目がおかしく', 'フロアから逃げ出す', '惑わしの薬・杖・罠'],
  ...
  ['油まみれ（oilyTurns）', '100', '100', '—', '炎・爆発ダメージ2倍', '炎・爆発ダメージ2倍', '油壺・油の罠'],
...
const WAND_DETAILS = {
  ...
  bewitch:      { normal:'敵を50T幻惑（逃げ回る）/ 自分は50T幻惑。ボスはtick半減', blessed:'敵は永続幻惑 / 自分は100T幻惑', cursed:'フロアの罠が全て見える' },
