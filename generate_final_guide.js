...
const indexData = [
  ...
  ['投擲ダメージ', '通常投擲の補正攻撃力は、武器=素の攻撃力、防具=素の防御力、指輪・巻物=1、壺=5、空き瓶・食料など=3。プレイヤー攻撃力・補正攻撃力・対象防御力による通常の飛び道具ダメージ計算を使い、壺も固定3〜6ダメージではない'],
  [''],
  ['データ来源'],
...
monsterData.push([
  ...
  'キーアイテム所持で上昇時',
  '-',
  '地下深くから地上へ近づくほど段階が上がり、強くなる。ボス扱いではない。撃破時は金貨と通常枠のランダムアイテムを各1つ落とす。'
]);
