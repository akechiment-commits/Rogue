...
const GUIDE_DESC_OVERRIDES = {
  ...
  "爆弾矢": "着弾点で爆発する矢。周囲8マスに地雷と同じ爆発効果。範囲内の石像は中身を出さず消滅する。装備して射撃する場合は1本ずつ、インベントリから「投げる」場合は束全体を1発にまとめて投げ、束が2本以上なら本数を直撃ダメージと爆発ダメージへ加算して全本数を消費する。単発の爆発は敵に8〜15、プレイヤーに10〜20を基礎値とし、油・ずぶ濡れ等の補正を受ける。99本まで束にできる。",
