...
const monsterData = [
  ...
  ['【共通】', '', '', '', '', '', '', '', '', '', '敵が敵を倒した場合も共通の撃破処理を通り、撃破者が1レベルアップ（次形態がない場合は強化）。撃破された敵の通常ドロップは発生するが、プレイヤーへの経験値は入らない。水上限定モンスターは通常移動・詰まり脱出・状態異常による自発移動でも水タイル／泉以外へ移動しない。'],
  ['─── 通常モンスター ───', '', '', '', '', '', '', '', '', '', ''],
];
