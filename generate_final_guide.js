...
function monTraits(m) {
  ...
  st.itemMimic = '出現時は通常アイテムの中からランダムに選んだグラフィックへ化けて床で待機する。プレイヤーがそのマスへ移動して拾おうとすると移動をキャンセルし、偽アイテムを消して正体を現し、その場から攻撃する。炎の杖・爆発などで偽アイテムが破壊されると本体も消滅し、吹き飛ばし等では床アイテムとして移動する';
