...
export const ITEMS = [
  ...
  { name:"みかわしのペン",   type:"pen",    effect:"dodge",         charges:2, rarity:"A", weight:2,  sellPrice:1500, desc:"足元にみかわしの魔方陣を描く。魔方陣のある部屋では投げたもの・矢・石が必ず外れる（魔法・炎は除く）。祝福でフロア全体。呪いで逆に投げたもの・矢・石が必ず命中するようになる。チャージ制。", tile:42 },
...
export const WANDS = [
  ...
  { name:"軟化の杖",       type:"wand", effect:"soften",    charges:5, rarity:"B", weight:4,  sellPrice:600,  desc:"振ると対象の防御力を半減する（祝福：4分の1）。アイテム・罠・大箱に当てると破壊。壁に当てると1マスがランダムな食料に変化。呪い：1マス先に壊せる壁を生成する。", tile:24 },
