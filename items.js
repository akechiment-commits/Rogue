...
export const BB_TYPES = [
  ...
  { kind: "curse",     name: "呪いの大箱", cap: () => rng(2, 4), desc: "入れたアイテムを呪う。壺は容量が1減る。食料は腐る。金貨・キーアイテムには効果がない。" },
  { kind: "scatter",   name: "拡散の大箱", cap: () => rng(3, 6), desc: "入れたアイテムを同じ部屋にいる全員に投げつけ消滅させる。薬は直接効果を与え、杖は効果を発動、それ以外は投げダメージ。" },
  { kind: "trash",     name: "ゴミ箱",     cap: () => 99,        desc: "入れたアイテムが消滅する。" },
];
