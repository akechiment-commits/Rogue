...
export const WANDS = [
  ...
  { name:"金縛りの杖",     type:"wand", effect:"paralyze",  charges:5, rarity:"A", weight:2,  sellPrice:2500, desc:"振ると対象を金縛りにする。何かアクションを受けるまで動けなくなる。祝福：2回アクションが必要な強金縛り。呪い：対象が200ターン状態異常（金縛り・眠り・鈍足）を防ぐ力を得る。",               tile:24 },
  ...
  { name:"レベルアップの杖", type:"wand", effect:"levelup", charges:3, rarity:"A", weight:2,  sellPrice:3000, desc:"振ると対象をレベルアップさせる。自分に使えば1レベル上がる。敵に当てると次の形態に変化する。呪い：自分なら1階上へ飛ばされ、敵ならレベルダウンする。水の瓶に当てるとレベルアップの薬になる。", tile:24 },
...
export const POTS = [
  ...
  { name:"保存の壺",           type:"pot", potEffect:"none",      capacity:5, rarity:"C", weight:8,  sellPrice:600,  desc:"アイテムを安全に保管できる。",         tile:32 },
...
/* ===== RINGS ===== */
export const RINGS = [
  { name: "力の指輪",       type:"ring", effect:"power_ring",   plus:0, rarity:"C", weight:3, sellPrice:300, tile:60, desc:"装備中、＋値の分だけ攻撃力が増える。合成や強化で＋値を上げられる。" },
  { name: "守りの指輪",     type:"ring", effect:"defense_ring", plus:0, rarity:"C", weight:3, sellPrice:300, tile:60, desc:"装備中、＋値の分だけ防御力が増える。合成や強化で＋値を上げられる。" },
  { name: "命の指輪",       type:"ring", effect:"life_ring",    plus:0, rarity:"C", weight:3, sellPrice:300, tile:60, desc:"装備中、＋値×5だけ最大HPが増える。合成や強化で＋値を上げられる。" },
  { name: "遠投の指輪",     type:"ring", effect:"farcast_ring",         rarity:"C", weight:2, sellPrice:250, tile:60, desc:"装備中、常に遠投状態で物を投げられる。" },
  { name: "浮遊の指輪",     type:"ring", effect:"float_ring",           rarity:"C", weight:2, sellPrice:350, tile:60, desc:"装備中、罠にかからなくなる。ただし階段を降りられなくなる。" },
  { name: "毒消しの指輪",   type:"ring", effect:"antidote_ring",        rarity:"C", weight:2, sellPrice:300, tile:60, desc:"装備中、毒が無効になる。" },
  { name: "値切りの指輪",   type:"ring", effect:"bargain_ring",         rarity:"B", weight:2, sellPrice:600, tile:60, desc:"装備中、店のアイテムが3割引で買える。" },
  ...
  { name: "回復の指輪",     type:"ring", effect:"regen_ring",           rarity:"B", weight:2, sellPrice:350, tile:60, desc:"装備中、お腹の減り方と自然回復の量が倍になる。" },
  { name: "爆発の指輪",     type:"ring", effect:"explode_ring",         rarity:"C", weight:1, sellPrice:80,  tile:60, desc:"装備時に自分が爆発する。装備中もたまに爆発する。" },
  { name: "松明の指輪",     type:"ring", effect:"torch_ring",           rarity:"B", weight:2, sellPrice:300, tile:60, desc:"装備中、視界範囲が1マス広がる。2つ装備すれば2マス広がる。" },
];
