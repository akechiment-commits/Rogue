...
export const RINGS = [
  ...
  { name: "透視の指輪",     type:"ring", effect:"clairvoyance_ring",      rarity:"A", weight:2, sellPrice:10000, tile:60, desc:"装備中、壁越しでもモンスターの位置が見え続ける。" },
  { name: "感知の指輪",     type:"ring", effect:"detect_ring",            rarity:"A", weight:2, sellPrice:10000, tile:60, desc:"装備中、フロア全体の落ちているアイテムの位置が見え続ける。" },
