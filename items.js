...
const _FAKE = {
  potion: ["赤い薬","青い薬","緑の薬","黄色い薬","紫の薬","白い薬","黒い薬",
           ...
           "水色の薬","薄紫の薬","灰色の薬","焦げ茶の薬","深紅の薬","緑青色の薬",
           "青緑の薬","黄緑の薬","藍色の薬","乳白色の薬","淡桃色の薬","濃紺の薬",
           "琥珀色の薬","真珠色の薬","虹色の薬","斑模様の薬","縞模様の薬","泡立つ薬",
           "香る薬","濁った薬"],
  scroll: ["渦巻き文字の巻物","点描の巻物","格子模様の巻物","縦縞の巻物",
           "古代文字の巻物","記号の巻物","逆文字の巻物","波模様の巻物",
           "星模様の巻物","魚拓の巻物","幾何学模様の巻物","解読不能の巻物",
           "赤い印の巻物","青い印の巻物","黒い印の巻物","白い印の巻物","金文字の巻物",
           "銀文字の巻物","破れた巻物","焦げた巻物","折れた巻物",
           "古びた巻物","真新しい巻物","半透明の巻物","光る巻物","くすんだ巻物",
           "細字の巻物","太字の巻物","二重線の巻物","三重線の巻物","円環模様の巻物",
           "三角模様の巻物","四角模様の巻物","月模様の巻物","太陽模様の巻物","星座模様の巻物",
           "花模様の巻物","葉模様の巻物","波線の巻物","螺旋模様の巻物","点線の巻物",
           "斜線の巻物","網目模様の巻物","刺繍模様の巻物","暗号文の巻物","象形文字の巻物",
           "鏡文字の巻物","欠けた文字の巻物","意味不明な文字の巻物"],
  wand:   ["カシの杖","バオバブの杖","ヒノキの杖","カエデの杖","マホガニーの杖",
           "ケヤキの杖","ブナの杖","クスノキの杖","ポプラの杖","イチョウの杖",
           "シラカバの杖","クリの杖","ナラの杖","スギの杖","ヤナギの杖",
           "トネリコの杖","サクラの杖","モミの杖","ヒバの杖","クヌギの杖",
           "カシワの杖","ヤマザクラの杖","モクセイの杖","ツバキの杖","アカマツの杖",
           "クロマツの杖","イヌマキの杖","ヒイラギの杖","サワラの杖","ハンノキの杖",
           "クルミの杖","ホオノキの杖","ヤマブキの杖","ツツジの杖","レンゲの杖",
           "スイレンの杖","フジの杖","アジサイの杖","ススキの杖","ヨモギの杖",
           "ハスの杖","カリンの杖","ビワの杖","ナツメの杖","ヤシの杖","カカオの杖"],
  pen:    ["朱色のペン","群青のペン","黄金のペン","翠色のペン","銀色のペン",
           "深紅のペン","琥珀のペン","碧色のペン","紫紺のペン","白銀のペン",
           "漆黒のペン","橙色のペン","茶色いペン","空色のペン","紺色のペン",
           "薔薇色のペン","苔色のペン","青磁色のペン","朱砂色のペン","瑠璃色のペン",
           "翡翠色のペン","珊瑚色のペン","菫色のペン","藤色のペン","山吹色のペン",
           "若草色のペン","群緑色のペン","灰桜色のペン","鳩羽色のペン","鉄紺色のペン",
           "葡萄色のペン","蘇芳色のペン","薄墨色のペン","生成り色のペン","鼠色のペン",
           "焦茶色のペン","乳白色のペン","虹色のペン"],
  pot:    ["丸い壺","四角い壺","細長い壺","平たい壺","瓢箪型の壺","古い壺",
           "新しい壺","大きな壺","小さな壺","模様入りの壺","光沢のある壺",
           "素焼きの壺","裂けた壺","青磁の壺","白磁の壺","赤銅の壺","黒陶の壺",
           "青銅の壺","鉄製の壺","木製の壺","石造りの壺","ガラスの壺","水玉模様の壺",
           "花柄の壺","葉柄の壺","星柄の壺","月柄の壺","太陽柄の壺","縞模様の壺",
           "斑点模様の壺","ひび割れた壺","蓋付きの壺","取っ手付きの壺","二重蓋の壺",
           "細口の壺","広口の壺","浅い壺","深い壺","重たい壺","軽い壺",
           "冷たい壺","温かい壺","湿った壺","乾いた壺","煙る壺","香る壺",
           "光る模様の壺",
           "透明な壺","黒い壺","白い壺","赤い壺","青い壺","緑の壺","紫の壺",
           "金色の壺","銀色の壺","虹色の壺"],
  spellbook: ["赤い表紙の魔法書","青い表紙の魔法書","黄色い表紙の魔法書","緑の表紙の魔法書",
              ...
              "赤い革装丁の魔法書","青い革装丁の魔法書","黒い革装丁の魔法書","白い革装丁の魔法書",
              "木の表紙の魔法書","金属の表紙の魔法書","透明な表紙の魔法書","ひび割れた表紙の魔法書",
              "刺繍入りの表紙の魔法書","紋章入りの表紙の魔法書","星柄の表紙の魔法書","月柄の表紙の魔法書",
              "古びた表紙の魔法書","真新しい表紙の魔法書","厚い表紙の魔法書","薄い表紙の魔法書",
              "鍵付きの表紙の魔法書"],
  ring:   ["銀色の指輪","金色の指輪","銅の指輪","鉄の指輪","宝石のついた指輪",
           "古びた指輪","光る指輪","曲がった指輪","彫刻のある指輪","紋章のある指輪",
           "太い指輪","細い指輪","黒い指輪","白い指輪","緑色の指輪",
           "赤い指輪","青い指輪","紫の指輪","木の指輪","石の指輪","骨の指輪",
           "翡翠の指輪","瑠璃の指輪","水晶の指輪","黒曜石の指輪","真珠の指輪","琥珀の指輪",
           "珊瑚の指輪","銀細工の指輪","金細工の指輪","銅細工の指輪","鉄細工の指輪",
           "花形の指輪","星形の指輪","月形の指輪","太陽形の指輪","蛇の指輪","竜の指輪",
           "狼の指輪","鳥の指輪","猫の指輪","蝶の指輪","蔦模様の指輪","花模様の指輪",
           "波模様の指輪","炎模様の指輪","氷模様の指輪","風模様の指輪","古代文字の指輪",
           "呪文刻印の指輪","欠けた指輪","ねじれた指輪","二重の指輪","細身の指輪"],
};

/* ガイド生成・テストからも参照する未識別名プール */
export const UNIDENTIFIED_NAME_POOLS = _FAKE;
...
export const BB_FAKE_NAMES = [
  ...
  "白い大箱", "紫の大箱", "橙色の大箱", "茶色い大箱", "青銅の大箱",
  "真鍮の大箱", "銅製の大箱", "漆塗りの大箱", "宝石付きの大箱", "鎖付きの大箱",
  "鍵付きの大箱", "蓋の重い大箱", "蓋の軽い大箱", "ひび割れた大箱", "傷だらけの大箱",
  "新品の大箱",
  "呪文刻印の大箱", "星模様の大箱", "月模様の大箱", "花模様の大箱", "蔦模様の大箱",
];
...
/**
 * プレイヤーに魔法封印を付与する（封印の罠と同じ sealedTurns）。
 * @returns {number} 付与したターン。防いだ場合は 0
 */
export function applyPlayerSeal(p, ml, opts = {}) {
  const {
    blessed = false,
    proofMsg = "封印効果を受けたが防具が防いだ！(耐封印)",
  } = opts;
  if (!p) return 0;
  if (blockPlayerStatus(p, ml, { proofAbility: "seal_proof", proofMsg })) return 0;
  const turns = statusTurns("seal", { kind: "player", blessed });
  p.sealedTurns = (p.sealedTurns || 0) + turns;
  return turns;
}
...
export const CRITICAL_ABILITY_IDS = [
  "critical", "critical_oni_club", "critical_war_god_axe", "critical_cat_claw",
];

/** 武器に宿る会心能力の合計率。各系統は合成で1回ずつ加算する。 */
export function weaponCriticalRate(weapon, sesameActive = false) {
...
export const WEAPON_ABILITIES = [
  ...
  { id:"critical_oni_club",    name:"会心",    desc:"会心の一撃が出やすくなる" },
  { id:"critical_war_god_axe", name:"会心",    desc:"会心の一撃が出やすくなる" },
  { id:"critical_cat_claw",    name:"会心",    desc:"会心の一撃が出やすくなる" },
...
export function applyPotionEffect(eff, val, kind, target, dg, p, ml, luFn, blessed = false, cursed = false, killerMon = null, skipKillerLevelUp = false) {
  ...
  switch (eff) {
    ...
    case "mana":
      if (kind === "player") {
        if (cursed) {
          const _st = applyPlayerSeal(p, ml, { proofMsg: "呪われた薬の封印を防具が防いだ！(耐封印)" });
          if (_st) ml.push(`魔力が封じられた！魔法封印${_st}ターン【呪】`);
    ...
    case "seal":
      ...
      if (kind === "player") {
        if (cursed) {
          ml.push(`${curePlayerSealWithCursedPotion(p)}【呪→解封】`);
        } else {
          const _st = applyPlayerSeal(p, ml, { blessed, proofMsg: "封印効果を受けたが防具が防いだ！(耐封印)" });
          if (_st) {
...
export function throwItemAlongLine(shooter, dg, item, dx, dy, range, ml, p, luFn, opts = {}) {
  ...
  if (res.spring) {
    ...
    if (isFireExplosionNullified(dg, p)) {
      ...
      ml.push("爆発！");
      doExplosion(res.x, res.y, dg, p, ml, nameFn, "爆弾矢の爆発", null, luFn, false, false, false, false, { projectileAtk: item.atk || 6 });
    }
...
export function advanceSpecialProjectiles(dg, p, ml, luFn, monsterSnapshots = null) {
  ...
  for (const sp of dg.specialProjectiles) {
    ...
    if (_monster) {
      if (sp.kind === "torpedo") {
        detonateTorpedo(sp, dg, p, ml, luFn, _monster);
        continue;
      }
  ...
  if (wakka) {
    ...
    if (st.bombArrow) {
      if (isFireExplosionNullified(dg, p)) {
        ...
        ml.push("爆発！");
        doExplosion(_wakkaTarget.x, _wakkaTarget.y, dg, p, ml, null, "爆弾矢の爆発", null, luFn, false, false, false, false, { projectileAtk: _arAtk });
      }
    }
    _ensureShopPeeled();
    return;
...
export const SPELLS=[
  ...
  {id:"regen_magic",     name:"再生の魔法",       mpCost:12, effect:"regen_magic",                needsDir:false, desc:"30ターン、通常の自然回復に3を上乗せする。Lvごとに持続+5ターン。MP:12"},
  {id:"time_stop_magic", name:"時間停止の魔法",   mpCost:25, effect:"time_stop_magic",            needsDir:false, desc:"世界全体を2回のプレイヤー行動分停止させる。Lvごとに+1行動。MP:25"},
  ...
  {id:"debug_get_cursed_item",  name:"[debug]呪いアイテム取得",mpCost:0,fixedMpCost:true,effect:"debug_get_cursed_item",  needsDir:false, debug:true, desc:"呪われた任意のアイテムを1個選んで入手する。MP:0"},
...
export const SPELLBOOKS=[
  ...
  {name:"氷の魔法書",       type:"spellbook",spell:"ice_bolt",        rarity:"C", weight:4,  sellPrice:2500,  desc:"読むと氷の弾で敵を凍らせ、スローにする魔法を習得する。MP:10",tile:43},
  {name:"雷の魔法書",       type:"spellbook",spell:"lightning_magic", rarity:"C", weight:4,  sellPrice:3000,  desc:"読むと視界内の全ての敵に雷ダメージを与える魔法を習得する。MP:12",tile:43},
  {name:"眠りの魔法書",     type:"spellbook",spell:"sleep_bolt",      rarity:"C", weight:4,  sellPrice:2500,  desc:"読むと眠りの霧を飛ばす魔法を習得する。MP:7",tile:43},
  {name:"テレポートの魔法書",type:"spellbook",spell:"teleport_magic", rarity:"B", weight:2,  sellPrice:5000,  desc:"読むとランダムな場所に飛ぶ魔法を習得する。MP:8",tile:43},
  {name:"テレポートアザーの魔法書",type:"spellbook",spell:"teleport_other",rarity:"B", weight:2,  sellPrice:5000,  desc:"読むと方向を選び、その先の敵をランダムにテレポートさせる魔法を習得する。MP:8",tile:43},
  {name:"毒の魔法書",            type:"spellbook",spell:"poison_bolt",   rarity:"C", weight:4,  sellPrice:2500,  desc:"読むと方向を選び、敵を毒状態にしてターン毎にダメージを与える魔法を習得する。MP:8",tile:43},
  {name:"透明の魔法書",          type:"spellbook",spell:"invisible_magic",rarity:"A", weight:1,  sellPrice:6000,  desc:"読むとしばらく透明になり、敵から見えなくなる魔法を習得する。MP:10",tile:43},
  {name:"壁抜けの魔法書",        type:"spellbook",spell:"wallwalk_magic", rarity:"A", weight:1,  sellPrice:8000,  desc:"読むとしばらく壁を通り抜けられる魔法を習得する。効果切れ時に壁中にいると押し出される。MP:12",tile:43},
  {name:"回復の魔法書",       type:"spellbook",spell:"heal_magic",       rarity:"B", weight:2,  sellPrice:5000,  desc:"読むとHPを回復する魔法を習得する。MP:15",tile:43},
  {name:"HP吸収の魔法書",    type:"spellbook",spell:"drain_hp",         rarity:"C", weight:4,  sellPrice:3000,  desc:"読むと方向を選び、敵のHPを吸い取って自分を回復する魔法を習得する。MP:12",tile:43},
  ...
  {name:"再生の魔法書",     type:"spellbook",spell:"regen_magic",     rarity:"B", weight:2,  sellPrice:4500,  desc:"読むと30ターン、通常の自然回復に3を上乗せする魔法を習得する。Lvごとに持続+5ターン。MP:12",tile:43},
  {name:"時間停止の魔法書", type:"spellbook",spell:"time_stop_magic", rarity:"A", weight:1,  sellPrice:10000, desc:"読むと世界全体を2回のプレイヤー行動分停止させる魔法を習得する。Lvごとに+1行動。MP:25",tile:43},
  ...
  switch (eff) {
    ...
    case "map_magic": {
      if (kind === "self") {
        ...
        ml.push("地図の魔法でフロア全体の地図が明らかになった！");
      }
      break;
    }
    ...
    case "regen_magic": {
      if (kind === "self") {
        const _turns = getSpellBuffDuration(30, lv);
        if ((p.magicRegenBonus || 0) <= 0) p.magicRegenBonus = 3;
        p.magicRegenTurns = (p.magicRegenTurns || 0) + _turns;
        ml.push(`再生の魔法で自然回復量が3上がった！(${_turns}ターン)`);
      }
      break;
    }
    case "time_stop_magic": {
      if (kind === "self") {
        const _turns = Math.max(1, Math.floor(Number(lv) || 1)) + 1;
    ...
    case "earthquake_magic": {
      if (kind === "self") {
        ...
        for (const _monster of _targets) {
          if (monEffectiveFloat(_monster) && !_monster.sealed && !hasGravityPentacle(dg, _monster.x, _monster.y)) {
            ml.push(`${_monster.name}は浮遊していて地震が効かなかった！`);
            continue;
          }
    ...
    case "item_gather_magic": {
      if (kind === "self") {
        const _gatherItems = (dg.items || []).filter((_item) => !_item.shopPrice);
        if (_gatherItems.length === 0) {
          ml.push("道具寄せの魔法を唱えたが、引き寄せるアイテムがない。");
          break;
        }
        const _gatherSet = new Set(_gatherItems);
        dg.items = (dg.items || []).filter((_item) => !_gatherSet.has(_item));
        const _gatherFt = new Set();
        for (const _item of _gatherItems) {
          delete _item.wallEmbedded;
          const _placed = placeItemAt(dg, p.x, p.y, _item, ml, _gatherFt, 0, p, _item.x, _item.y);
          if (!_placed && !dg.items.includes(_item) &&
              !dg.waterItems?.some((_waterItem) => _waterItem.item === _item)) {
            ml.push(`${resolveItemName(_item)}は引き寄せられなかった！`);
          }
        }
        ml.push(`${_gatherItems.length}個のアイテムを引き寄せた！`);
      }
      break;
    }
    case "fire_bolt": {
