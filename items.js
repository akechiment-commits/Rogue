...
export const ITEMS = [
  ...
  { name:"武器強化の巻物",   type:"scroll", effect:"weapon_up",          rarity:"B", weight:4,  sellPrice:800,  desc:"選んだ武器・防具・指輪の＋値を1上げる。",        tile:18 },
  { name:"防具強化の巻物",   type:"scroll", effect:"armor_up",           rarity:"B", weight:4,  sellPrice:800,  desc:"選んだ武器・防具・指輪の＋値を1上げる。",        tile:18 },
