...
export const RINGS = [
  ...
  { name: "魔物呼びの指輪", type:"ring", effect:"spawn_ring",           rarity:"D", weight:8, sellPrice:500,  tile:60, desc:"装備中、敵が現れやすくなる。" },
  { name: "下手投げの指輪", type:"ring", effect:"miss_throw_ring",      rarity:"E", weight:12, sellPrice:500,  tile:60, desc:"装備中、投げたものが必ず外れるようになる。" },
