...
- 拾い投げ（`itemThrower`）は中級14〜20階・上級11〜25階を中心に出現する。プレイヤーを認識すると、隣接していない間は最寄りの床アイテムへ移動してその上で拾い、非隣接かつ8方向の一直線上（Lv1:5／Lv2:8／Lv3:10マス）に立つと投げつける。拾ったターンは投げず、投げる前に倒された場合は所持アイテムを床へ落とす。
