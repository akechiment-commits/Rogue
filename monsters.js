...
export const MONS = [
  ...
  { name: "コボルド",     hp: 15,  atk: 8,  def: 2,  exp: 10,  speed: 1,   tile: 7,  kind: "humanoid", baseKind: "kobold",        monLevel: 1, minFloor: 2,  maxFloor: 13, dungeonFloors: { beginner: { min: 3, max: 6 }, intermediate: { min: 3, max: 9 }, advanced: { min: 3, max: 18 } },
    levels: [
      { name: "コボルド戦士",       hp: 26,  atk: 13, def: 7,  exp: 16, dungeonFloors: { advanced: { min: 10, max: 14 } } },
      { name: "コボルド族長",       hp: 40,  atk: 17, def: 11, exp: 25, dungeonFloors: { advanced: { min: 15, max: 18 } } },
    ],
  },
  { name: "ゴブリン",     hp: 23,  atk: 16, def: 5,  exp: 20,  speed: 1,   tile: 8,  kind: "humanoid", baseKind: "goblin",        monLevel: 1, minFloor: 3,  maxFloor: 16, dungeonFloors: { beginner: { min: 4, max: 7 }, intermediate: { min: 3, max: 10 }, advanced: { min: 3, max: 20 } },
    levels: [
      { name: "ゴブリン頭",         hp: 45,  atk: 22, def: 9,  exp: 32, dungeonFloors: { advanced: { min: 12, max: 16 } } },
      { name: "ゴブリン王",         hp: 68,  atk: 28, def: 15, exp: 50, dungeonFloors: { advanced: { min: 17, max: 20 } } },
    ],
  },
