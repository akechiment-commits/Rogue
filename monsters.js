...
export const MONS = [
  ...
  { name: "ムカデ",       hp: 10,  atk: 4,  def: 2,  exp: 5,   speed: 1,   tile: 12,  kind: "beast",   baseKind: "centipede",     monLevel: 1, minFloor: 1,  maxFloor: 9,  dungeonFloors: { beginner: { min: 2, max: 5 } },
    levels: [
      { name: "大ムカデ",               hp: 17,  atk: 7,  def: 4,  exp: 9   },
      { name: "覇ムカデ",               hp: 27,  atk: 10, def: 6,  exp: 14  },
    ],
  },
  { name: "弾き師",       hp: 30,  atk: 14, def: 3,  exp: 42,  speed: 1,   tile: 39,  kind: "humanoid", baseKind: "itemblaster",  monLevel: 1, minFloor: 6,  maxFloor: 22, subtype: "itemblast", dungeonFloors: { beginner: null },
    levels: [
      { name: "大弾き師",               hp: 48,  atk: 19, def: 5,  exp: 68  },
      { name: "覇弾き師",               hp: 70,  atk: 24, def: 8,  exp: 98  },
    ],
  },
  { name: "盗投士",       hp: 28,  atk: 13, def: 3,  exp: 45,  speed: 1,   tile: 69, kind: "humanoid", baseKind: "stealthrower", monLevel: 1, minFloor: 8,  maxFloor: 24, subtype: "stealthrower", dungeonFloors: { beginner: null },
    levels: [
  ...
  { name: "ゴブリン",     hp: 23,  atk: 13, def: 5,  exp: 20,  speed: 1,   tile: 8,  kind: "humanoid", baseKind: "goblin",        monLevel: 1, minFloor: 3,  maxFloor: 16, dungeonFloors: { beginner: { min: 4, max: 7 } },
    levels: [
      { name: "ゴブリン頭",         hp: 45,  atk: 18, def: 9,  exp: 32  },
      { name: "ゴブリン王",         hp: 68,  atk: 23, def: 15, exp: 50  },
    ],
  },
  { name: "インプ",       hp: 26,  atk: 15, def: 4,  exp: 28,  speed: 2,   tile: 53, kind: "beast",    baseKind: "imp",           monLevel: 1, minFloor: 3,  maxFloor: 17, float: true, dungeonFloors: { beginner: { min: 6, max: 9 } },
    levels: [
  ...
  { name: "罠猟師",       hp: 38,  atk: 17, def: 5,  exp: 55,  speed: 1,   tile: 39, kind: "humanoid", baseKind: "trapthrower",   monLevel: 1, minFloor: 18, maxFloor: 50, subtype: "trapthrower",
    levels: [
  ...
  { name: "解装士",       hp: 38,  atk: 17, def: 5,  exp: 58,  speed: 1,   tile: 59, kind: "humanoid", baseKind: "disarmer",      monLevel: 1, minFloor: 19, maxFloor: 50, subtype: "disarmer",
    levels: [
      { name: "強解装士",           hp: 61,  atk: 23, def: 9,  exp: 93  },
      { name: "覇解装士",           hp: 95,  atk: 30, def: 13, exp: 145 },
    ],
  },
  { name: "投擲士",       hp: 43,  atk: 18, def: 6,  exp: 62,  speed: 1,   tile: 11, kind: "humanoid", baseKind: "monsterthrow",  monLevel: 1, minFloor: 20, maxFloor: 50, subtype: "monsterthrow",
    levels: [
  ...
  { name: "突進角獣",    hp: 62,  atk: 22, def: 8,  exp: 62,  speed: 1,   tile: 56, kind: "beast",    baseKind: "charger",       monLevel: 1, minFloor: 10, maxFloor: 35, subtype: "charger", dungeonFloors: { beginner: null },
    levels: [
      { name: "強突進角獣",         hp: 99,  atk: 32, def: 12, exp: 99  },
      { name: "覇突進角獣",         hp: 155, atk: 44, def: 16, exp: 155 },
    ],
  },
  { name: "ミラーゴーレム", hp: 68, atk: 20, def: 18, exp: 70, speed: 1,   tile: 57, kind: "beast",   baseKind: "reflector",     monLevel: 1, minFloor: 12, maxFloor: 45, subtype: "reflector",
    levels: [
      { name: "強ミラーゴーレム",   hp: 109, atk: 29, def: 24, exp: 112 },
      { name: "覇ミラーゴーレム",   hp: 170, atk: 38, def: 31, exp: 175 },
    ],
  },
  { name: "ハンマーオーガ", hp: 75, atk: 30, def: 9,  exp: 80,  speed: 1,   tile: 13, kind: "humanoid", baseKind: "knocker",      monLevel: 1, minFloor: 15, maxFloor: 50, subtype: "knocker",
    levels: [
  ...
  { name: "薬投げ師",     hp: 30,  atk: 13, def: 3,  exp: 48,  speed: 1,   tile: 44, kind: "humanoid", baseKind: "potionthrower", monLevel: 1, minFloor: 10, maxFloor: 50, subtype: "potionthrow", dungeonFloors: { beginner: null },
    levels: [
