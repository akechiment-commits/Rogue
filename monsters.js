...
export const MONS = [
  ...
  { name: "バット",       hp: 8,   atk: 5,  def: 0,  exp: 4,   speed: 1,   tile: 103, kind: "beast",   baseKind: "bat",           monLevel: 1, minFloor: 1,  maxFloor: 9,  float: true, dungeonFloors: { beginner: { min: 1, max: 4 }, intermediate: { min: 1, max: 7 } },
    levels: [
  ...
  { name: "マイナーダイミョウ", hp: 30,  atk: 17, def: 3,  exp: 42,  speed: 1,   tile: 39,  kind: "humanoid", baseKind: "itemblaster",  monLevel: 1, minFloor: 6,  maxFloor: 22, subtype: "itemblast", dungeonFloors: { beginner: null, intermediate: { min: 11, max: 16 } },
    levels: [
      { name: "メジャーダイミョウ",     hp: 48,  atk: 23, def: 5,  exp: 68  },
      { name: "ミフネ",                 hp: 70,  atk: 29, def: 8,  exp: 98  },
    ],
  },
  { name: "盗投士",       hp: 28,  atk: 16, def: 3,  exp: 45,  speed: 1,   tile: 69, kind: "humanoid", baseKind: "stealthrower", monLevel: 1, minFloor: 8,  maxFloor: 24, subtype: "stealthrower", dungeonFloors: { beginner: null, intermediate: { min: 12, max: 17 } },
    levels: [
  ...
  { name: "フクマル",     hp: 11,  atk: 0,  def: 0,  exp: 50,  speed: 2,   tile: 70, kind: "beast",    baseKind: "runner",        monLevel: 1, minFloor: 5,  maxFloor: 30, subtype: "runner", dungeonFloors: { beginner: { min: 5, max: 8 }, intermediate: { min: 4, max: 18 } },
    levels: [
  ...
  { name: "ウルフ",       hp: 27,  atk: 20, def: 2,  exp: 40,  speed: 2,   tile: 56, kind: "beast",    baseKind: "wolf",          monLevel: 1, minFloor: 9,  maxFloor: 22, dungeonFloors: { beginner: null, intermediate: { min: 11, max: 17 } },
    levels: [
      { name: "強ウルフ",           hp: 43,  atk: 28, def: 6,  exp: 64  },
      { name: "フェンリル",         hp: 68,  atk: 36, def: 10, exp: 100 },
    ],
  },
  { name: "コソドロ",     hp: 16,  atk: 7,  def: 0,  exp: 35,  speed: 2,   tile: 69, kind: "humanoid", baseKind: "thief",         monLevel: 1, minFloor: 9,  maxFloor: 20, subtype: "thief", dungeonFloors: { beginner: null, intermediate: { min: 11, max: 16 } },
    levels: [
      { name: "大盗賊",             hp: 27,  atk: 11, def: 2,  exp: 56  },
      { name: "怪盗",               hp: 43,  atk: 14, def: 3,  exp: 88  },
    ],
  },
  { name: "レプラコーン", hp: 20,  atk: 9,  def: 1,  exp: 38,  speed: 2,   tile: 109, kind: "humanoid", baseKind: "leprechaun",    monLevel: 1, minFloor: 11, maxFloor: 24, subtype: "goldthief", dungeonFloors: { beginner: null, intermediate: { min: 11, max: 17 } },
    levels: [
  ...
  { name: "ボルガ",       hp: 28,  atk: 12, def: 0,  exp: 60,  speed: 1,   tile: 8,  kind: "humanoid", baseKind: "bombgoblin",    monLevel: 1, minFloor: 12, maxFloor: 26, subtype: "kamikaze", dungeonFloors: { intermediate: { min: 13, max: 18 } },
    levels: [
  ...
  { name: "ゼラチンキューブ", hp: 81, atk: 22, def: 5, exp: 70,  speed: 0.5, tile: 79, kind: "beast", baseKind: "gelcube",       monLevel: 1, minFloor: 15, maxFloor: 50, elemWeak: "fire", dungeonFloors: { intermediate: { min: 15, max: 19 } },
    levels: [
      { name: "強ゼラチンキューブ", hp: 130, atk: 31, def: 9,  exp: 112 },
      { name: "覇ゼラチンキューブ", hp: 203, atk: 40, def: 13, exp: 175 },
    ],
  },
  { name: "岩砕き",       hp: 68,  atk: 28, def: 7,  exp: 65,  speed: 0.5, tile: 76, kind: "beast",    baseKind: "walldigger",    monLevel: 1, minFloor: 16, maxFloor: 50, wallDigger: true, dungeonFloors: { intermediate: { min: 15, max: 19 } },
    levels: [
      { name: "強岩砕き",           hp: 108, atk: 38, def: 12, exp: 104 },
      { name: "覇岩砕き",           hp: 169, atk: 50, def: 16, exp: 163 },
    ],
  },
  { name: "罠師",         hp: 34,  atk: 18, def: 3,  exp: 48,  speed: 1,   tile: 86, kind: "humanoid", baseKind: "trapmaster",    monLevel: 1, minFloor: 16, maxFloor: 50, subtype: "trapmaster", dungeonFloors: { intermediate: { min: 15, max: 19 } },
    levels: [
      { name: "罠の達人",           hp: 54,  atk: 25, def: 7,  exp: 77  },
      { name: "罠の覇者",           hp: 85,  atk: 32, def: 12, exp: 120 },
    ],
  },
  { name: "大蛇",         hp: 47,  atk: 24, def: 5,  exp: 52,  speed: 1,   tile: 12, kind: "beast",    baseKind: "serpent",       monLevel: 1, minFloor: 17, maxFloor: 50, maxAttacks: 2, dungeonFloors: { intermediate: { min: 15, max: 19 } },
    levels: [
      { name: "強大蛇",             hp: 76,  atk: 32, def: 9,  exp: 83  },
      { name: "覇大蛇",             hp: 119, atk: 42, def: 13, exp: 130 },
    ],
  },
  { name: "ゴールドタイガー", hp: 38,  atk: 20, def: 5,  exp: 55,  speed: 1,   tile: 39, kind: "humanoid", baseKind: "trapthrower",   monLevel: 1, minFloor: 18, maxFloor: 50, subtype: "trapthrower", dungeonFloors: { intermediate: { min: 17, max: 20 } },
    levels: [
      { name: "ずっと見てタイガー", hp: 61,  atk: 28, def: 9,  exp: 88  },
      { name: "よく頑張っタイガー", hp: 95,  atk: 36, def: 13, exp: 138 },
    ],
  },
  { name: "呪術師",       hp: 34,  atk: 17, def: 5,  exp: 55,  speed: 1,   tile: 44, kind: "humanoid", baseKind: "witchdoc",      monLevel: 1, minFloor: 18, maxFloor: 50, subtype: "wanduser", wandEffect: "curse_wand", dungeonFloors: { intermediate: { min: 17, max: 20 } },
    levels: [
      { name: "強呪術師",           hp: 54,  atk: 24, def: 9,  exp: 88  },
      { name: "大呪術師",           hp: 85,  atk: 29, def: 13, exp: 138 },
    ],
  },
  { name: "解装士",       hp: 38,  atk: 20, def: 5,  exp: 58,  speed: 1,   tile: 59, kind: "humanoid", baseKind: "disarmer",      monLevel: 1, minFloor: 19, maxFloor: 50, subtype: "disarmer", dungeonFloors: { intermediate: { min: 18, max: 20 } },
    levels: [
      { name: "強解装士",           hp: 61,  atk: 28, def: 9,  exp: 93  },
      { name: "覇解装士",           hp: 95,  atk: 36, def: 13, exp: 145 },
    ],
  },
  { name: "かいりきベア", hp: 43,  atk: 22, def: 6,  exp: 62,  speed: 1,   tile: 11, kind: "humanoid", baseKind: "monsterthrow",  monLevel: 1, minFloor: 20, maxFloor: 50, subtype: "monsterthrow", dungeonFloors: { intermediate: { min: 18, max: 20 } },
    levels: [
      { name: "かいりきベア・セブン", hp: 69,  atk: 31, def: 10, exp: 99  },
      { name: "かいりきベア・イレブン", hp: 108, atk: 40, def: 14, exp: 155 },
    ],
  },
  { name: "シャーマン",   hp: 41,  atk: 17, def: 5,  exp: 60,  speed: 1,   tile: 55, kind: "humanoid", baseKind: "shaman",        monLevel: 1, minFloor: 21, maxFloor: 50, subtype: "supporter", dungeonFloors: { intermediate: { min: 17, max: 20 } },
    levels: [
  ...
  { name: "バリア蟹",     hp: 43,  atk: 20, def: 3,  exp: 68,  speed: 1,   tile: 54, kind: "humanoid", baseKind: "barriermage",   monLevel: 1, minFloor: 22, maxFloor: 50, barrier: 1, dungeonFloors: { intermediate: { min: 18, max: 20 } },
    levels: [
      { name: "シールド蟹",         hp: 69,  atk: 28, def: 6,  exp: 109, barrier: 2 },
      { name: "なんでも無効蟹",     hp: 108, atk: 36, def: 9,  exp: 170, barrier: 3 },
    ],
  },
  { name: "ウィンドメイジ", hp: 38, atk: 20, def: 5, exp: 65,  speed: 1,   tile: 54, kind: "humanoid", baseKind: "windmage",     monLevel: 1, minFloor: 23, maxFloor: 50, subtype: "wanduser", wandEffect: "blowback_wand", dungeonFloors: { intermediate: { min: 18, max: 20 } },
    levels: [
      { name: "強ウィンドメイジ",   hp: 61,  atk: 28, def: 9,  exp: 104 },
      { name: "風の覇者",           hp: 95,  atk: 36, def: 13, exp: 163 },
    ],
  },
  { name: "混乱術師",     hp: 41,  atk: 20, def: 5,  exp: 72,  speed: 1,   tile: 81, kind: "humanoid", baseKind: "confusemage",   monLevel: 1, minFloor: 23, maxFloor: 50, subtype: "wanduser", wandEffect: "confuse_wand", dungeonFloors: { intermediate: { min: 17, max: 20 } },
    levels: [
      { name: "強混乱術師",         hp: 65,  atk: 28, def: 9,  exp: 115 },
      { name: "大混乱術師",         hp: 101, atk: 35, def: 13, exp: 180 },
    ],
  },
  { name: "引きダコ",     hp: 61,  atk: 24, def: 6,  exp: 75,  speed: 1,   tile: 78, kind: "beast",    baseKind: "puller",        monLevel: 1, minFloor: 24, maxFloor: 50, subtype: "puller", dungeonFloors: { intermediate: { min: 18, max: 20 } },
    levels: [
      { name: "強引きダコ",         hp: 97,  atk: 32, def: 10, exp: 120 },
      { name: "覇引きダコ",         hp: 153, atk: 43, def: 14, exp: 188 },
    ],
  },
  { name: "眠り術師",     hp: 43,  atk: 22, def: 6,  exp: 80,  speed: 1,   tile: 82, kind: "humanoid", baseKind: "sleepmage",     monLevel: 1, minFloor: 25, maxFloor: 50, subtype: "wanduser", wandEffect: "sleep_wand", dungeonFloors: { intermediate: { min: 19, max: 20 } },
    levels: [
      { name: "強眠り術師",         hp: 69,  atk: 29, def: 10, exp: 128 },
      { name: "大眠り術師",         hp: 108, atk: 36, def: 16, exp: 200 },
    ],
  },
  { name: "トロル",       hp: 68,  atk: 29, def: 9,  exp: 75,  speed: 1,   tile: 13, kind: "humanoid", baseKind: "troll",         monLevel: 1, minFloor: 25, maxFloor: 50, dungeonFloors: { intermediate: { min: 19, max: 20 } },
    levels: [
      { name: "強トロル",           hp: 108, atk: 40, def: 13, exp: 120 },
      { name: "覇トロル",           hp: 169, atk: 53, def: 17, exp: 188 },
    ],
  },
  { name: "火ダルマ",     hp: 74,  atk: 36, def: 6,  exp: 110, speed: 1,   tile: 61, kind: "beast",    baseKind: "firedemon",     monLevel: 1, minFloor: 25, maxFloor: 50, float: true, dungeonFloors: { intermediate: { min: 19, max: 20 } },
    levels: [
  ...
  { name: "ほっちもぺ",   hp: 68, atk: 24, def: 18, exp: 70, speed: 1,   tile: 57, kind: "beast",   baseKind: "reflector",     monLevel: 1, minFloor: 12, maxFloor: 45, subtype: "reflector", dungeonFloors: { intermediate: { min: 12, max: 18 } },
    levels: [
      { name: "ほっちんもっぺ",     hp: 109, atk: 35, def: 24, exp: 112 },
      { name: "むちちむち",         hp: 170, atk: 46, def: 31, exp: 175 },
    ],
  },
  { name: "ハンマーオーガ", hp: 75, atk: 36, def: 9,  exp: 80,  speed: 1,   tile: 13, kind: "humanoid", baseKind: "knocker",      monLevel: 1, minFloor: 15, maxFloor: 50, subtype: "knocker", dungeonFloors: { intermediate: { min: 15, max: 19 } },
    levels: [
      { name: "強ハンマーオーガ",   hp: 120, atk: 52, def: 13, exp: 128 },
      { name: "覇ハンマーオーガ",   hp: 188, atk: 67, def: 17, exp: 200 },
    ],
  },
  { name: "魔法反射師",   hp: 38,  atk: 19, def: 8,  exp: 75,  speed: 1,   tile: 55, kind: "humanoid", baseKind: "magicreflector", monLevel: 1, minFloor: 13, maxFloor: 50, subtype: "magicreflect", dungeonFloors: { intermediate: { min: 16, max: 20 } },
    levels: [
      { name: "強魔法反射師",       hp: 61,  atk: 26, def: 13, exp: 120 },
      { name: "覇魔法反射師",       hp: 95,  atk: 35, def: 18, exp: 188 },
    ],
  },
  { name: "薬師",         hp: 30,  atk: 16, def: 3,  exp: 48,  speed: 1,   tile: 44, kind: "humanoid", baseKind: "potionthrower", monLevel: 1, minFloor: 10, maxFloor: 50, subtype: "potionthrow", dungeonFloors: { beginner: null, intermediate: { min: 11, max: 18 } },
    levels: [
