...
export const MONS = [
  ...
  { name: "バット",       hp: 8,   atk: 5,  def: 0,  exp: 4,   speed: 1,   tile: 103, kind: "beast",   baseKind: "bat",           monLevel: 1, minFloor: 1,  maxFloor: 9,  float: true, flightOnly: true, dungeonFloors: { beginner: { min: 1, max: 4 }, intermediate: { min: 1, max: 6 }, advanced: { min: 1, max: 4 } },
    levels: [
  ...
  { name: "ムカデ",       hp: 10,  atk: 4,  def: 2,  exp: 5,   speed: 1,   tile: 12,  kind: "beast",   baseKind: "centipede",     monLevel: 1, minFloor: 1,  maxFloor: 9,  dungeonFloors: { beginner: { min: 2, max: 5 }, intermediate: { min: 1, max: 6 }, advanced: { min: 1, max: 5 } },
    levels: [
  ...
  { name: "ひったくり",   hp: 28,  atk: 16, def: 3,  exp: 45,  speed: 1,   tile: 153, kind: "humanoid", baseKind: "stealthrower", monLevel: 1, minFloor: 8,  maxFloor: 24, subtype: "stealthrower", dungeonFloors: { beginner: null, intermediate: { min: 12, max: 17 }, advanced: { min: 9, max: 17 } },
    levels: [
      { name: "分捕り",                 hp: 46,  atk: 22, def: 5,  exp: 72,  dungeonFloors: { advanced: { min: 24, max: 26 } } },
      { name: "根刮ぎ",                 hp: 67,  atk: 29, def: 8,  exp: 108 },
    ],
  },
  { name: "コボルド",     hp: 15,  atk: 8,  def: 2,  exp: 10,  speed: 1,   tile: 7,  kind: "humanoid", baseKind: "kobold",        monLevel: 1, minFloor: 2,  maxFloor: 13, dungeonFloors: { beginner: { min: 3, max: 6 }, intermediate: { min: 2, max: 8 }, advanced: { min: 4, max: 5 } },
    levels: [
  ...
  { name: "ゴブリン",     hp: 23,  atk: 16, def: 5,  exp: 20,  speed: 1,   tile: 8,  kind: "humanoid", baseKind: "goblin",        monLevel: 1, minFloor: 3,  maxFloor: 16, dungeonFloors: { beginner: { min: 5, max: 7 }, intermediate: { min: 3, max: 9 }, advanced: { min: 5, max: 7 } },
    levels: [
  ...
  { name: "スケルトン",   hp: 24,  atk: 19, def: 5,  exp: 25,  speed: 1,   tile: 9,  kind: "undead",   baseKind: "skeleton",      monLevel: 1, minFloor: 4,  maxFloor: 18, dungeonFloors: { beginner: { min: 7, max: 9 }, intermediate: { min: 4, max: 10 }, advanced: { min: 5, max: 12 } },
    levels: [
  ...
  { name: "フクマル",     hp: 11,  atk: 0,  def: 0,  exp: 50,  speed: 2,   tile: 171, kind: "beast",    baseKind: "runner",        monLevel: 1, minFloor: 5,  maxFloor: 30, subtype: "runner", dungeonFloors: { beginner: { min: 5, max: 8 }, intermediate: { min: 4, max: 11 }, advanced: { min: 4, max: 22 } },
    levels: [
  ...
  { name: "ゾンビ",       hp: 38,  atk: 16, def: 5,  exp: 40,  speed: 0.5, tile: 10, kind: "undead",   baseKind: "zombie",        monLevel: 1, minFloor: 6,  maxFloor: 19, elemWeak: "fire", dungeonFloors: { beginner: { min: 7, max: 10 }, intermediate: { min: 7, max: 13 }, advanced: { min: 5, max: 14 } },
    levels: [
  ...
  { name: "ワッカ",       hp: 24,  atk: 17, def: 2,  exp: 28,  speed: 1,   tile: 172, kind: "beast",    baseKind: "wokka",         monLevel: 1, minFloor: 6,  maxFloor: 18, waterWalker: true, subtype: "stonethrow", dungeonFloors: { beginner: { min: 9, max: 10 }, intermediate: { min: 7, max: 13 }, advanced: { min: 6, max: 14 } },
    levels: [
      { name: "ぷにぷにワッカ",     hp: 38,  atk: 24, def: 5,  exp: 45 },
      { name: "シン・ワッカ",       hp: 61,  atk: 32, def: 7,  exp: 72 },
    ],
  },
  { name: "分裂スライム", hp: 30,  atk: 14, def: 2,  exp: 32,  speed: 1,   tile: 113, kind: "beast",    baseKind: "slime",         monLevel: 1, minFloor: 7,  maxFloor: 20, elemWeak: "fire", subtype: "splitter", dungeonFloors: { beginner: { min: 7, max: 10 }, intermediate: { min: 7, max: 13 }, advanced: { min: 6, max: 14 } },
    levels: [
      { name: "緑分裂スライム",     hp: 47,  atk: 22, def: 5,  exp: 51 },
      { name: "赤分裂スライム",     hp: 74,  atk: 29, def: 7,  exp: 80 },
    ],
  },
  { name: "アーチャー",   hp: 30,  atk: 18, def: 3,  exp: 34,  speed: 1,   tile: 148, kind: "humanoid", baseKind: "archer",        monLevel: 1, minFloor: 8,  maxFloor: 21, subtype: "archer", dungeonFloors: { beginner: { min: 7, max: 10 }, intermediate: { min: 5, max: 11 }, advanced: { min: 5, max: 12 } },
    levels: [
  ...
  { name: "ウルフ",       hp: 27,  atk: 20, def: 2,  exp: 40,  speed: 2,   tile: 56, kind: "beast",    baseKind: "wolf",          monLevel: 1, minFloor: 9,  maxFloor: 22, dungeonFloors: { beginner: null, intermediate: { min: 11, max: 16 }, advanced: { min: 7, max: 16 } },
    levels: [
  ...
  { name: "コソドロ",     hp: 16,  atk: 7,  def: 0,  exp: 35,  speed: 2,   tile: 170, kind: "humanoid", baseKind: "thief",         monLevel: 1, minFloor: 9,  maxFloor: 20, subtype: "thief", dungeonFloors: { beginner: null, intermediate: { min: 10, max: 14 }, advanced: { min: 7, max: 16 } },
    levels: [
      { name: "大盗賊",             hp: 27,  atk: 11, def: 2,  exp: 56  },
      { name: "怪盗",               hp: 43,  atk: 14, def: 3,  exp: 88  },
    ],
  },
  { name: "レプラコーン", hp: 20,  atk: 9,  def: 1,  exp: 38,  speed: 2,   tile: 109, kind: "humanoid", baseKind: "leprechaun",    monLevel: 1, minFloor: 11, maxFloor: 24, subtype: "goldthief", dungeonFloors: { beginner: null, intermediate: { min: 12, max: 16 }, advanced: { min: 7, max: 16 } },
    levels: [
      { name: "強レプラコーン",       hp: 33,  atk: 13, def: 3,  exp: 61  },
      { name: "覇レプラコーン",       hp: 52,  atk: 17, def: 5,  exp: 95  },
    ],
  },
  { name: "錆虫",         hp: 24,  atk: 13, def: 2,  exp: 40,  speed: 1,   tile: 75, kind: "beast",    baseKind: "rustbug",       monLevel: 1, minFloor: 10, maxFloor: 23, elemWeak: "thunder", subtype: "ruster", dungeonFloors: { beginner: null, intermediate: { min: 11, max: 16 }, advanced: { min: 8, max: 17 } },
    levels: [
      { name: "強錆虫",             hp: 39,  atk: 18, def: 5,  exp: 64,  dungeonFloors: { advanced: { min: 21, max: 23 } } },
      { name: "覇錆虫",             hp: 61,  atk: 25, def: 7,  exp: 100 },
    ],
  },
  { name: "足払い鬼",     hp: 20,  atk: 11, def: 2,  exp: 28,  speed: 1,   tile: 151, kind: "humanoid", baseKind: "tripper",      monLevel: 1, minFloor: 5,  maxFloor: 24, subtype: "tripper", dungeonFloors: { beginner: { min: 5, max: 8 }, intermediate: { min: 5, max: 11 }, advanced: { min: 7, max: 16 } },
    levels: [
      { name: "強足払い鬼",         hp: 46,  atk: 21, def: 6,  exp: 68,  dungeonFloors: { advanced: { min: 18, max: 22 } } },
      { name: "覇足払い鬼",         hp: 68,  atk: 28, def: 10, exp: 100 },
    ],
  },
  { name: "ウィザード",   hp: 24,  atk: 17, def: 3,  exp: 42,  speed: 1,   tile: 175, kind: "humanoid", baseKind: "wizard",        monLevel: 1, minFloor: 11, maxFloor: 24, subtype: "wanduser", randomElementalWands: true, dungeonFloors: { intermediate: { min: 11, max: 16 }, advanced: { min: 9, max: 17 } },
    levels: [
      { name: "強ウィザード",       hp: 39,  atk: 24, def: 7,  exp: 67,  dungeonFloors: { advanced: { min: 22, max: 25 } } },
      { name: "大魔導士",           hp: 61,  atk: 29, def: 12, exp: 105 },
    ],
  },
  { name: "カラペン",     hp: 32,  atk: 15, def: 4,  exp: 48,  speed: 1,   tile: 183, kind: "beast",    baseKind: "itempusher",  monLevel: 1, minFloor: 11, maxFloor: 30, float: true, subtype: "itempusher", dungeonFloors: { beginner: null, intermediate: { min: 12, max: 17 }, advanced: { min: 9, max: 22 } },
    levels: [
  ...
  { name: "アイテムモドキ", hp: 38,  atk: 19, def: 5,  exp: 54,  speed: 1,   tile: 167, kind: "beast",    baseKind: "itemMimic",  monLevel: 1, minFloor: 9, maxFloor: 30, subtype: "itemMimic", dungeonFloors: { beginner: null, intermediate: { min: 8, max: 14 }, advanced: { min: 8, max: 21 } },
  ...
  { name: "拾い投げ",     hp: 43,  atk: 20, def: 5,  exp: 62,  speed: 1,   tile: 163, kind: "humanoid", baseKind: "itemThrower",  monLevel: 1, minFloor: 13, maxFloor: 35, subtype: "itemThrower", dungeonFloors: { beginner: null, intermediate: { min: 14, max: 18 }, advanced: { min: 11, max: 25 } },
  ...
  { name: "ボムスライム", hp: 38,  atk: 14, def: 2,  exp: 55,  speed: 1,   tile: 114, kind: "beast",    baseKind: "bombslime",     monLevel: 1, minFloor: 11, maxFloor: 24, elemWeak: "fire", subtype: "deathbomb", dungeonFloors: { intermediate: { min: 13, max: 17 }, advanced: { min: 10, max: 19 } },
    levels: [
      { name: "強ボムスライム",     hp: 61,  atk: 22, def: 3,  exp: 88  },
      { name: "覇ボムスライム",     hp: 95,  atk: 29, def: 5,  exp: 138 },
    ],
  },
  { name: "ボルガ",       hp: 28,  atk: 12, def: 0,  exp: 60,  speed: 1,   tile: 159, kind: "humanoid", baseKind: "bombgoblin",    monLevel: 1, minFloor: 12, maxFloor: 26, subtype: "kamikaze", dungeonFloors: { intermediate: { min: 13, max: 17 }, advanced: { min: 10, max: 19 } },
    levels: [
      { name: "ボルガ博士",         hp: 48,  atk: 18, def: 2,  exp: 96,  speed: 1 },
      { name: "頭の中にダイナマイト", hp: 75, atk: 24, def: 4,  exp: 150 },
    ],
  },
  { name: "水晶スライム", hp: 5,   atk: 18, def: 0,  exp: 50,  speed: 1,   tile: 115, kind: "beast",    baseKind: "crystalslime",  monLevel: 1, minFloor: 13, maxFloor: 26, elemWeak: "fire", fixedDamageOnly: true, dungeonFloors: { intermediate: { min: 13, max: 17 }, advanced: { min: 10, max: 19 } },
    levels: [
      { name: "プラチナスライム",   hp: 8,   atk: 25, def: 0,  exp: 80  },
      { name: "ダマスカスライム",   hp: 11,  atk: 32, def: 0,  exp: 125 },
    ],
  },
  { name: "ゴースト",     hp: 38,  atk: 18, def: 5,  exp: 45,  speed: 1,   tile: 145, kind: "undead",   baseKind: "rockspirit",    monLevel: 1, minFloor: 14, maxFloor: 28, wallWalker: true, dungeonFloors: { intermediate: { min: 13, max: 18 }, advanced: { min: 10, max: 20 } },
    levels: [
  ...
  { name: "オーク",       hp: 41,  atk: 22, def: 7,  exp: 48,  speed: 1,   tile: 11, kind: "humanoid", baseKind: "orc",           monLevel: 1, minFloor: 14, maxFloor: 26, subtype: "powercharge", desc: "隣接時に力を溜めることがある。力を溜めた次のターンだけ、防御力を無視する痛恨の一撃を放つ。", dungeonFloors: { intermediate: { min: 13, max: 18 }, advanced: { min: 10, max: 19 } },
    levels: [
  ...
  { name: "合成獣",       hp: 54,  atk: 20, def: 5,  exp: 80,  speed: 0.5, tile: 176, kind: "beast",    baseKind: "synthmonster",  monLevel: 1, minFloor: 21, maxFloor: 50, dungeonFloors: { intermediate: null, advanced: { min: 16, max: 26 } },
    levels: [
  ...
  { name: "ドラゴン",     hp: 122, atk: 43, def: 14, exp: 140, speed: 1,   tile: 14, kind: "dragon",   baseKind: "dragon",        monLevel: 1, minFloor: 27, maxFloor: 50, elemWeak: "ice", dungeonFloors: { intermediate: null, advanced: { min: 22, max: 30 } },
    levels: [
      { name: "レッドドラゴン",       hp: 194, atk: 61, def: 19, exp: 224 },
      { name: "エンシェントドラゴン", hp: 304, atk: 78, def: 23, exp: 350 },
    ],
  },
  { name: "ゴーレム",     hp: 135, atk: 36, def: 23, exp: 115, speed: 0.5, tile: 57, kind: "beast",    baseKind: "golem",         monLevel: 1, minFloor: 27, maxFloor: 50, elemWeak: "thunder", dungeonFloors: { intermediate: null, advanced: { min: 25, max: 30 } },
    levels: [
      { name: "ゴーレムLv2",        hp: 216, atk: 50, def: 28, exp: 184 },
      { name: "ゴーレムーガ",       hp: 338, atk: 65, def: 34, exp: 288 },
    ],
  },
  ...
  /* ===== 新型モンスター4種 ===== */
  { name: "からめ鬼",    hp: 34,  atk: 14, def: 6,  exp: 42,  speed: 1,   tile: 108, kind: "beast",    baseKind: "grabber",       monLevel: 1, minFloor: 5,  maxFloor: 15, subtype: "grabber", dungeonFloors: { beginner: { min: 7, max: 10 }, intermediate: { min: 6, max: 12 }, advanced: { min: 6, max: 13 } },
    levels: [
  ...
  { name: "突進角獣",    hp: 62,  atk: 26, def: 8,  exp: 62,  speed: 1,   tile: 168, kind: "beast",    baseKind: "charger",       monLevel: 1, minFloor: 10, maxFloor: 35, subtype: "charger", dungeonFloors: { beginner: null, intermediate: { min: 9, max: 15 }, advanced: { min: 8, max: 18 } },
    levels: [
      { name: "激突角獣",           hp: 99,  atk: 38, def: 12, exp: 99,  dungeonFloors: { advanced: { min: 23, max: 25 } } },
      { name: "猪突角獣",           hp: 155, atk: 53, def: 16, exp: 155 },
    ],
  },
  { name: "ほっちもぺ",   hp: 68, atk: 24, def: 18, exp: 70, speed: 1,   tile: 169, kind: "beast",   baseKind: "reflector",     monLevel: 1, minFloor: 12, maxFloor: 45, subtype: "reflector", dungeonFloors: { intermediate: { min: 12, max: 17 }, advanced: { min: 9, max: 18 } },
    levels: [
  ...
  { name: "ミラーマン",   hp: 38,  atk: 19, def: 8,  exp: 75,  speed: 1,   tile: 166, kind: "humanoid", baseKind: "magicreflector", monLevel: 1, minFloor: 13, maxFloor: 50, subtype: "magicreflect", dungeonFloors: { intermediate: { min: 16, max: 20 }, advanced: { min: 12, max: 22 } },
    levels: [
      { name: "全反射マン",         hp: 61,  atk: 26, def: 13, exp: 120 },
      { name: "ペルセウスマン",     hp: 95,  atk: 35, def: 18, exp: 188 },
    ],
  },
  { name: "薬師",         hp: 22,  atk: 12, def: 2,  exp: 32,  speed: 1,   tile: 163, kind: "humanoid", baseKind: "potionthrower", monLevel: 1, minFloor: 6,  maxFloor: 50, subtype: "potionthrow", dungeonFloors: { beginner: { min: 6, max: 9 }, intermediate: { min: 6, max: 12 }, advanced: { min: 8, max: 18 } },
    levels: [
  ...
  { name: "ルカチュウ", hp: 35, atk: 18, def: 4,  exp: 58,  speed: 1,   tile: 160, kind: "humanoid", baseKind: "killplaster",   monLevel: 1, minFloor: 12, maxFloor: 45, subtype: "defhalf", magicImmune: true, dungeonFloors: { intermediate: null, advanced: { min: 11, max: 21 } },
    levels: [
      { name: "ナンチュウ",       hp: 56,  atk: 25, def: 7,  exp: 92,  dungeonFloors: { advanced: { min: 25, max: 27 } } },
      { name: "ラプラス",         hp: 88,  atk: 36, def: 11, exp: 148 },
    ],
  },
  ...
  { name: "氷竜",         hp: 65,  atk: 32, def: 10, exp: 125, speed: 1,   tile: 162, kind: "beast",    baseKind: "icedragon",     monLevel: 1, minFloor: 18, maxFloor: 50, elemWeak: "thunder", dungeonFloors: { intermediate: null, advanced: { min: 21, max: 30 } },
    levels: [
      { name: "ブルードラゴン",             hp: 105, atk: 44, def: 16, exp: 200 },
      { name: "ブルードラゴン 天界の七竜", hp: 168, atk: 58, def: 22, exp: 320 },
    ],
  },
  { name: "わてり",       hp: 40,  atk: 19, def: 6,  exp: 48,  speed: 1,   tile: 93, kind: "beast",    baseKind: "wateri",        monLevel: 1, minFloor: 6,  maxFloor: 20, elemWeak: "thunder", waterOnly: true, subtype: "watergunner", dungeonFloors: { beginner: null, intermediate: { min: 13, max: 18 }, advanced: { min: 12, max: 22 } },
    levels: [
  ...
  /* ===== 視界操作モンスター ===== */
  { name: "スターライト", hp: 55,  atk: 26, def: 8,  exp: 80,  speed: 1,   tile: 165, kind: "beast",   baseKind: "starlight",     monLevel: 1, minFloor: 15, maxFloor: 50, float: true, flightOnly: true, dungeonFloors: { intermediate: null, advanced: { min: 16, max: 27 } },
  ...
  { name: "ダークネス",   hp: 65,  atk: 30, def: 10, exp: 95,  speed: 1,   tile: 152, kind: "beast",   baseKind: "darkness",      monLevel: 1, minFloor: 20, maxFloor: 50, float: true, flightOnly: true, dungeonFloors: { intermediate: null, advanced: { min: 21, max: 30 } },
  ...
  { name: "タトゥーバード", hp: 28,  atk: 12, def: 3,  exp: 42,  speed: 1,   tile: 112, kind: "beast",   baseKind: "tattoobird",    monLevel: 1, minFloor: 10, maxFloor: 30, float: true, subtype: "tattoobird", dungeonFloors: { beginner: null, intermediate: { min: 9, max: 15 }, advanced: { min: 8, max: 16 } },
    desc: "浮遊する鳥。近接攻撃を50%の確率でひらりとかわし、当たっても50%でフェザーガードが発動しダメージを半減。自身の攻撃は25%で痛恨の一撃。",
    levels: [
      { name: "スカーバード",   hp: 52,  atk: 21, def: 7,  exp: 78,  dungeonFloors: { intermediate: { min: 16, max: 20 }, advanced: { min: 14, max: 22 } } },
      { name: "クレストバード", hp: 85,  atk: 30, def: 13, exp: 135, speed: 2,  dungeonFloors: { advanced: { min: 22, max: 28 } } },
    ],
  },
  /* ===== ラクガキ魔：同部屋で自分の足元に魔方陣を描く ===== */
  { name: "ラクガキ魔",   hp: 18,  atk: 7,  def: 2,  exp: 28,  speed: 1,   tile: 111, kind: "humanoid", baseKind: "rakugakima",    monLevel: 1, minFloor: 6,  maxFloor: 30, subtype: "pentaclePainter", dungeonFloors: { beginner: { min: 6, max: 9 }, intermediate: { min: 7, max: 13 }, advanced: { min: 8, max: 15 } },
    desc: "同じ部屋にいると自分の足元に魔方陣を描いてくる。レベルが上がるほど凶悪な魔方陣に。",
    levels: [
      { name: "ラクガキ妖精",       hp: 42,  atk: 17, def: 7,  exp: 70,  dungeonFloors: { intermediate: { min: 14, max: 20 }, advanced: { min: 15, max: 22 } } },
      { name: "ラクガキバンシー",   hp: 68,  atk: 25, def: 12, exp: 118, dungeonFloors: { advanced: { min: 22, max: 28 } } },
    ],
  },
  /* ===== ものまね師：隣接キャラの特技を模倣 ===== */
  { name: "ものまね師",   hp: 34,  atk: 17, def: 5,  exp: 72,  speed: 1,   tile: 167, kind: "humanoid", baseKind: "mimic",         monLevel: 1, minFloor: 12, maxFloor: 50, subtype: "mimic", dungeonFloors: { beginner: null, intermediate: { min: 14, max: 18 }, advanced: { min: 12, max: 24 } },
  ...
  { name: "スネークマン", hp: 43, atk: 20, def: 5, exp: 62, speed: 1, tile: 204, kind: "dragon", baseKind: "lizardman", monLevel: 1, minFloor: 13, maxFloor: 17, waterWalker: true, subtype: "armorbreath", dungeonFloors: { beginner: null, intermediate: { min: 13, max: 18 }, advanced: { min: 13, max: 17 } },
    desc: "水上・水中を移動する。プレイヤーを視界に捉えると25%でロックアーマーを使い、自分か隣接する敵の防御力をレベルに応じて5／7／10上げる。放置すると重ね掛けでどんどん硬くなる。強化解除の巻物や封印で解除される。",
    levels: [
      { name: "リザードマン", hp: 69, atk: 29, def: 9, exp: 100, minFloor: 20, maxFloor: 24, dungeonFloors: { intermediate: { min: 18, max: 20 }, advanced: { min: 20, max: 24 } } },
      { name: "とかげせんし", hp: 108, atk: 40, def: 14, exp: 158, minFloor: 27, maxFloor: 30, dungeonFloors: { advanced: { min: 27, max: 30 } } },
    ],
  },
  { name: "竜騎士", hp: 43, atk: 20, def: 5, exp: 62, speed: 1, tile: 205, kind: "dragon", baseKind: "dragonknight", monLevel: 1, minFloor: 13, maxFloor: 17, float: true, subtype: "diamondweapon", dungeonFloors: { beginner: null, intermediate: { min: 13, max: 18 }, advanced: { min: 13, max: 17 } },
    desc: "浮遊する竜騎士。プレイヤーを視界に捉えると25%でダイヤモンドウエポンを使い、自分か隣接する敵の攻撃力をレベルに応じて5／7／10上げる。放置すると重ね掛けでどんどん強くなる。強化解除の巻物や封印で解除される。",
    levels: [
      { name: "竜騎士04", hp: 69, atk: 29, def: 9, exp: 100, minFloor: 20, maxFloor: 24, dungeonFloors: { intermediate: { min: 18, max: 20 }, advanced: { min: 20, max: 24 } } },
