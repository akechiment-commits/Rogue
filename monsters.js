...
export const MONS = [
  ...
  { name: "弾き師",       hp: 30,  atk: 14, def: 3,  exp: 42,  speed: 1,   tile: 39,  kind: "humanoid", baseKind: "itemblaster",  monLevel: 1, minFloor: 6,  maxFloor: 22, subtype: "itemblast", dungeonFloors: { beginner: null, intermediate: { min: 9, max: 15 } },
    levels: [
      { name: "大弾き師",               hp: 48,  atk: 19, def: 5,  exp: 68  },
      { name: "覇弾き師",               hp: 70,  atk: 24, def: 8,  exp: 98  },
    ],
  },
  { name: "盗投士",       hp: 28,  atk: 13, def: 3,  exp: 45,  speed: 1,   tile: 69, kind: "humanoid", baseKind: "stealthrower", monLevel: 1, minFloor: 8,  maxFloor: 24, subtype: "stealthrower", dungeonFloors: { beginner: null, intermediate: { min: 9, max: 15 } },
    levels: [
  ...
  { name: "ゴブリン",     hp: 23,  atk: 13, def: 5,  exp: 20,  speed: 1,   tile: 8,  kind: "humanoid", baseKind: "goblin",        monLevel: 1, minFloor: 3,  maxFloor: 16, dungeonFloors: { beginner: { min: 4, max: 7 }, intermediate: { min: 3, max: 10 } },
    levels: [
      { name: "ゴブリン頭",         hp: 45,  atk: 18, def: 9,  exp: 32  },
      { name: "ゴブリン王",         hp: 68,  atk: 23, def: 15, exp: 50  },
    ],
  },
  { name: "インプ",       hp: 26,  atk: 15, def: 4,  exp: 28,  speed: 2,   tile: 53, kind: "beast",    baseKind: "imp",           monLevel: 1, minFloor: 3,  maxFloor: 17, float: true, dungeonFloors: { beginner: { min: 6, max: 9 }, intermediate: { min: 6, max: 12 } },
    levels: [
      { name: "強インプ",           hp: 42,  atk: 19, def: 7,  exp: 45  },
      { name: "覇インプ",           hp: 65,  atk: 25, def: 11, exp: 70  },
    ],
  },
  { name: "スケルトン",   hp: 24,  atk: 16, def: 5,  exp: 25,  speed: 1,   tile: 9,  kind: "undead",   baseKind: "skeleton",      monLevel: 1, minFloor: 4,  maxFloor: 18, dungeonFloors: { beginner: { min: 5, max: 8 }, intermediate: { min: 3, max: 11 } },
    levels: [
  ...
  { name: "ゾンビ",       hp: 55,  atk: 20, def: 5,  exp: 45,  speed: 0.5, tile: 10, kind: "undead",   baseKind: "zombie",        monLevel: 1, minFloor: 6,  maxFloor: 19, elemWeak: "fire", dungeonFloors: { beginner: { min: 8, max: 10 }, intermediate: { min: 9, max: 15 } },
    levels: [
      { name: "強ゾンビ",           hp: 85,  atk: 28, def: 12, exp: 72  },
      { name: "屍鬼",               hp: 130, atk: 35, def: 18, exp: 110 },
    ],
  },
  { name: "ワッカ",       hp: 24,  atk: 14, def: 2,  exp: 28,  speed: 1,   tile: 67, kind: "beast",    baseKind: "wokka",         monLevel: 1, minFloor: 6,  maxFloor: 18, subtype: "stonethrow", dungeonFloors: { beginner: { min: 8, max: 10 }, intermediate: { min: 9, max: 14 } },
    levels: [
      { name: "強ワッカ",           hp: 38,  atk: 20, def: 5,  exp: 45  },
      { name: "覇ワッカ",           hp: 61,  atk: 27, def: 7,  exp: 72  },
    ],
  },
  { name: "分裂スライム", hp: 30,  atk: 12, def: 2,  exp: 32,  speed: 1,   tile: 77, kind: "beast",    baseKind: "slime",         monLevel: 1, minFloor: 7,  maxFloor: 20, elemWeak: "fire", subtype: "splitter", dungeonFloors: { beginner: { min: 7, max: 10 }, intermediate: { min: 9, max: 15 } },
    levels: [
      { name: "強スライム",         hp: 47,  atk: 18, def: 5,  exp: 51  },
      { name: "覇スライム",         hp: 74,  atk: 24, def: 7,  exp: 80  },
    ],
  },
  { name: "アーチャー",   hp: 30,  atk: 15, def: 3,  exp: 34,  speed: 1,   tile: 39, kind: "humanoid", baseKind: "archer",        monLevel: 1, minFloor: 8,  maxFloor: 21, subtype: "archer", dungeonFloors: { beginner: { min: 5, max: 8 }, intermediate: { min: 6, max: 12 } },
    levels: [
      { name: "古参アーチャー",     hp: 47,  atk: 21, def: 7,  exp: 54  },
      { name: "弓の達人",           hp: 74,  atk: 27, def: 12, exp: 85  },
    ],
  },
  { name: "ウルフ",       hp: 27,  atk: 17, def: 2,  exp: 40,  speed: 2,   tile: 56, kind: "beast",    baseKind: "wolf",          monLevel: 1, minFloor: 9,  maxFloor: 22, dungeonFloors: { beginner: null, intermediate: { min: 6, max: 12 } },
    levels: [
      { name: "強ウルフ",           hp: 43,  atk: 23, def: 6,  exp: 64  },
      { name: "フェンリル",         hp: 68,  atk: 30, def: 10, exp: 100 },
    ],
  },
  { name: "コソドロ",     hp: 16,  atk: 6,  def: 0,  exp: 35,  speed: 2,   tile: 69, kind: "humanoid", baseKind: "thief",         monLevel: 1, minFloor: 9,  maxFloor: 20, subtype: "thief", dungeonFloors: { beginner: null, intermediate: { min: 6, max: 13 } },
    levels: [
      { name: "大盗賊",             hp: 27,  atk: 9,  def: 2,  exp: 56  },
      { name: "怪盗",               hp: 43,  atk: 12, def: 3,  exp: 88  },
    ],
  },
  { name: "錆虫",         hp: 24,  atk: 11, def: 2,  exp: 40,  speed: 1,   tile: 75, kind: "beast",    baseKind: "rustbug",       monLevel: 1, minFloor: 10, maxFloor: 23, elemWeak: "thunder", subtype: "ruster", dungeonFloors: { beginner: null, intermediate: { min: 11, max: 17 } },
    levels: [
      { name: "強錆虫",             hp: 39,  atk: 15, def: 5,  exp: 64  },
      { name: "覇錆虫",             hp: 61,  atk: 21, def: 7,  exp: 100 },
    ],
  },
  { name: "ウィザード",   hp: 24,  atk: 14, def: 3,  exp: 42,  speed: 1,   tile: 40, kind: "humanoid", baseKind: "wizard",        monLevel: 1, minFloor: 11, maxFloor: 24, subtype: "wanduser", wandEffect: "lightning", dungeonFloors: { intermediate: { min: 11, max: 17 } },
    levels: [
      { name: "強ウィザード",       hp: 39,  atk: 20, def: 7,  exp: 67  },
      { name: "大魔導士",           hp: 61,  atk: 24, def: 12, exp: 105 },
    ],
  },
  { name: "ボムスライム", hp: 38,  atk: 12, def: 2,  exp: 55,  speed: 1,   tile: 77, kind: "beast",    baseKind: "bombslime",     monLevel: 1, minFloor: 11, maxFloor: 24, elemWeak: "fire", subtype: "deathbomb", dungeonFloors: { intermediate: { min: 13, max: 18 } },
    levels: [
      { name: "強ボムスライム",     hp: 61,  atk: 18, def: 3,  exp: 88  },
      { name: "覇ボムスライム",     hp: 95,  atk: 24, def: 5,  exp: 138 },
    ],
  },
  { name: "爆弾ゴブリン", hp: 1,   atk: 12, def: 0,  exp: 60,  speed: 2,   tile: 8,  kind: "humanoid", baseKind: "bombgoblin",    monLevel: 1, minFloor: 12, maxFloor: 26, subtype: "kamikaze", dungeonFloors: { intermediate: { min: 13, max: 18 } },
    levels: [
      { name: "強爆弾ゴブリン",     hp: 1,   atk: 18, def: 0,  exp: 96  },
      { name: "自爆狂",             hp: 1,   atk: 24, def: 0,  exp: 150 },
    ],
  },
  { name: "水晶スライム", hp: 5,   atk: 15, def: 0,  exp: 50,  speed: 1,   tile: 77, kind: "beast",    baseKind: "crystalslime",  monLevel: 1, minFloor: 13, maxFloor: 26, elemWeak: "fire", fixedDamageOnly: true, dungeonFloors: { intermediate: { min: 13, max: 18 } },
    levels: [
      { name: "強水晶スライム",     hp: 8,   atk: 21, def: 0,  exp: 80  },
      { name: "覇水晶スライム",     hp: 11,  atk: 27, def: 0,  exp: 125 },
    ],
  },
  { name: "岩霊",         hp: 38,  atk: 15, def: 5,  exp: 45,  speed: 1,   tile: 68, kind: "undead",   baseKind: "rockspirit",    monLevel: 1, minFloor: 14, maxFloor: 28, wallWalker: true, dungeonFloors: { intermediate: { min: 13, max: 19 } },
    levels: [
      { name: "強岩霊",             hp: 61,  atk: 21, def: 9,  exp: 72  },
      { name: "岩の王",             hp: 95,  atk: 27, def: 13, exp: 113 },
    ],
  },
  { name: "オーク",       hp: 41,  atk: 18, def: 7,  exp: 48,  speed: 1,   tile: 11, kind: "humanoid", baseKind: "orc",           monLevel: 1, minFloor: 14, maxFloor: 26, dungeonFloors: { intermediate: { min: 13, max: 19 } },
    levels: [
      { name: "オーク将",           hp: 65,  atk: 26, def: 12, exp: 77  },
      { name: "オーク王",           hp: 101, atk: 33, def: 16, exp: 120 },
    ],
  },
  { name: "ゼラチンキューブ", hp: 81, atk: 18, def: 5, exp: 70,  speed: 0.5, tile: 79, kind: "beast", baseKind: "gelcube",       monLevel: 1, minFloor: 15, maxFloor: 50, elemWeak: "fire", dungeonFloors: { intermediate: { min: 16, max: 19 } },
    levels: [
      { name: "強ゼラチンキューブ", hp: 130, atk: 26, def: 9,  exp: 112 },
      { name: "覇ゼラチンキューブ", hp: 203, atk: 33, def: 13, exp: 175 },
    ],
  },
  { name: "岩砕き",       hp: 68,  atk: 23, def: 7,  exp: 65,  speed: 0.5, tile: 76, kind: "beast",    baseKind: "walldigger",    monLevel: 1, minFloor: 16, maxFloor: 50, wallDigger: true, dungeonFloors: { intermediate: { min: 16, max: 19 } },
    levels: [
      { name: "強岩砕き",           hp: 108, atk: 32, def: 12, exp: 104 },
      { name: "覇岩砕き",           hp: 169, atk: 42, def: 16, exp: 163 },
    ],
  },
  { name: "罠師",         hp: 34,  atk: 15, def: 3,  exp: 48,  speed: 1,   tile: 86, kind: "humanoid", baseKind: "trapmaster",    monLevel: 1, minFloor: 16, maxFloor: 50, subtype: "trapmaster", dungeonFloors: { intermediate: { min: 16, max: 19 } },
    levels: [
      { name: "罠の達人",           hp: 54,  atk: 21, def: 7,  exp: 77  },
      { name: "罠の覇者",           hp: 85,  atk: 27, def: 12, exp: 120 },
    ],
  },
  { name: "大蛇",         hp: 47,  atk: 20, def: 5,  exp: 52,  speed: 1,   tile: 12, kind: "beast",    baseKind: "serpent",       monLevel: 1, minFloor: 17, maxFloor: 50, maxAttacks: 2, dungeonFloors: { intermediate: { min: 16, max: 19 } },
    levels: [
      { name: "強大蛇",             hp: 76,  atk: 27, def: 9,  exp: 83  },
      { name: "覇大蛇",             hp: 119, atk: 35, def: 13, exp: 130 },
    ],
  },
  { name: "罠猟師",       hp: 38,  atk: 17, def: 5,  exp: 55,  speed: 1,   tile: 39, kind: "humanoid", baseKind: "trapthrower",   monLevel: 1, minFloor: 18, maxFloor: 50, subtype: "trapthrower", dungeonFloors: { intermediate: { min: 18, max: 19 } },
    levels: [
      { name: "罠猟師長",           hp: 61,  atk: 23, def: 9,  exp: 88  },
      { name: "罠猟師頭",           hp: 95,  atk: 30, def: 13, exp: 138 },
    ],
  },
  { name: "呪術師",       hp: 34,  atk: 14, def: 5,  exp: 55,  speed: 1,   tile: 44, kind: "humanoid", baseKind: "witchdoc",      monLevel: 1, minFloor: 18, maxFloor: 50, subtype: "wanduser", wandEffect: "curse_wand", dungeonFloors: { intermediate: { min: 18, max: 19 } },
    levels: [
      { name: "強呪術師",           hp: 54,  atk: 20, def: 9,  exp: 88  },
      { name: "大呪術師",           hp: 85,  atk: 24, def: 13, exp: 138 },
    ],
  },
  { name: "解装士",       hp: 38,  atk: 17, def: 5,  exp: 58,  speed: 1,   tile: 59, kind: "humanoid", baseKind: "disarmer",      monLevel: 1, minFloor: 19, maxFloor: 50, subtype: "disarmer", dungeonFloors: { intermediate: { min: 18, max: 19 } },
    levels: [
      { name: "強解装士",           hp: 61,  atk: 23, def: 9,  exp: 93  },
      { name: "覇解装士",           hp: 95,  atk: 30, def: 13, exp: 145 },
    ],
  },
  { name: "投擲士",       hp: 43,  atk: 18, def: 6,  exp: 62,  speed: 1,   tile: 11, kind: "humanoid", baseKind: "monsterthrow",  monLevel: 1, minFloor: 20, maxFloor: 50, subtype: "monsterthrow", dungeonFloors: { intermediate: { min: 18, max: 19 } },
    levels: [
      { name: "強投擲士",           hp: 69,  atk: 26, def: 10, exp: 99  },
      { name: "覇投擲士",           hp: 108, atk: 33, def: 14, exp: 155 },
    ],
  },
  { name: "シャーマン",   hp: 41,  atk: 14, def: 5,  exp: 60,  speed: 1,   tile: 55, kind: "humanoid", baseKind: "shaman",        monLevel: 1, minFloor: 21, maxFloor: 50, subtype: "supporter", dungeonFloors: { intermediate: { min: 18, max: 19 } },
    levels: [
  ...
  { name: "バリア術師",   hp: 43,  atk: 17, def: 3,  exp: 68,  speed: 1,   tile: 54, kind: "humanoid", baseKind: "barriermage",   monLevel: 1, minFloor: 22, maxFloor: 50, barrier: 1,
    levels: [
  ...
  { name: "引きダコ",     hp: 61,  atk: 20, def: 6,  exp: 75,  speed: 1,   tile: 78, kind: "beast",    baseKind: "puller",        monLevel: 1, minFloor: 24, maxFloor: 50, subtype: "puller", dungeonFloors: { intermediate: { min: 18, max: 19 } },
    levels: [
      { name: "強引きダコ",         hp: 97,  atk: 27, def: 10, exp: 120 },
      { name: "覇引きダコ",         hp: 153, atk: 36, def: 14, exp: 188 },
    ],
  },
  { name: "眠り術師",     hp: 43,  atk: 18, def: 6,  exp: 80,  speed: 1,   tile: 82, kind: "humanoid", baseKind: "sleepmage",     monLevel: 1, minFloor: 25, maxFloor: 50, subtype: "wanduser", wandEffect: "sleep_wand", dungeonFloors: { intermediate: { min: 18, max: 19 } },
    levels: [
      { name: "強眠り術師",         hp: 69,  atk: 24, def: 10, exp: 128 },
      { name: "大眠り術師",         hp: 108, atk: 30, def: 16, exp: 200 },
    ],
  },
  { name: "トロル",       hp: 68,  atk: 24, def: 9,  exp: 75,  speed: 1,   tile: 13, kind: "humanoid", baseKind: "troll",         monLevel: 1, minFloor: 25, maxFloor: 50, dungeonFloors: { intermediate: { min: 18, max: 19 } },
    levels: [
      { name: "強トロル",           hp: 108, atk: 33, def: 13, exp: 120 },
      { name: "覇トロル",           hp: 169, atk: 44, def: 17, exp: 188 },
    ],
  },
  { name: "火ダルマ",     hp: 74,  atk: 30, def: 6,  exp: 110, speed: 1,   tile: 61, kind: "beast",    baseKind: "firedemon",     monLevel: 1, minFloor: 25, maxFloor: 50, float: true, dungeonFloors: { intermediate: { min: 18, max: 19 } },
    levels: [
  ...
  /* ===== 新型モンスター4種 ===== */
  { name: "からめ鬼",    hp: 55,  atk: 18, def: 10, exp: 55,  speed: 1,   tile: 108, kind: "beast",    baseKind: "grabber",       monLevel: 1, minFloor: 5,  maxFloor: 15, subtype: "grabber", dungeonFloors: { beginner: { min: 6, max: 9 }, intermediate: { min: 6, max: 13 } },
    levels: [
      { name: "強からめ鬼",         hp: 88,  atk: 27, def: 14, exp: 88  },
      { name: "覇からめ鬼",         hp: 138, atk: 36, def: 19, exp: 138 },
    ],
  },
  { name: "突進角獣",    hp: 62,  atk: 22, def: 8,  exp: 62,  speed: 1,   tile: 56, kind: "beast",    baseKind: "charger",       monLevel: 1, minFloor: 10, maxFloor: 35, subtype: "charger", dungeonFloors: { beginner: null, intermediate: { min: 11, max: 18 } },
    levels: [
      { name: "強突進角獣",         hp: 99,  atk: 32, def: 12, exp: 99  },
      { name: "覇突進角獣",         hp: 155, atk: 44, def: 16, exp: 155 },
    ],
  },
  { name: "ミラーゴーレム", hp: 68, atk: 20, def: 18, exp: 70, speed: 1,   tile: 57, kind: "beast",   baseKind: "reflector",     monLevel: 1, minFloor: 12, maxFloor: 45, subtype: "reflector", dungeonFloors: { intermediate: { min: 11, max: 18 } },
    levels: [
      { name: "強ミラーゴーレム",   hp: 109, atk: 29, def: 24, exp: 112 },
      { name: "覇ミラーゴーレム",   hp: 170, atk: 38, def: 31, exp: 175 },
    ],
  },
  { name: "ハンマーオーガ", hp: 75, atk: 30, def: 9,  exp: 80,  speed: 1,   tile: 13, kind: "humanoid", baseKind: "knocker",      monLevel: 1, minFloor: 15, maxFloor: 50, subtype: "knocker", dungeonFloors: { intermediate: { min: 16, max: 19 } },
    levels: [
      { name: "強ハンマーオーガ",   hp: 120, atk: 43, def: 13, exp: 128 },
      { name: "覇ハンマーオーガ",   hp: 188, atk: 56, def: 17, exp: 200 },
    ],
  },
  { name: "魔法反射師",   hp: 38,  atk: 16, def: 8,  exp: 75,  speed: 1,   tile: 55, kind: "humanoid", baseKind: "magicreflector", monLevel: 1, minFloor: 13, maxFloor: 50, subtype: "magicreflect",
    levels: [
      { name: "強魔法反射師",       hp: 61,  atk: 22, def: 13, exp: 120 },
      { name: "覇魔法反射師",       hp: 95,  atk: 29, def: 18, exp: 188 },
    ],
  },
  { name: "薬投げ師",     hp: 30,  atk: 13, def: 3,  exp: 48,  speed: 1,   tile: 44, kind: "humanoid", baseKind: "potionthrower", monLevel: 1, minFloor: 10, maxFloor: 50, subtype: "potionthrow", dungeonFloors: { beginner: null, intermediate: { min: 11, max: 18 } },
    levels: [
      { name: "強薬投げ師",         hp: 48,  atk: 18, def: 6,  exp: 76  },
      { name: "覇薬投げ師",         hp: 75,  atk: 24, def: 10, exp: 120 },
    ],
  },
  { name: "バーサーカー", hp: 55,  atk: 22, def: 8,  exp: 65,  speed: 1,   tile: 13, kind: "humanoid", baseKind: "berserker",     monLevel: 1, minFloor: 12, maxFloor: 45, subtype: "berserker",
    levels: [
      { name: "大バーサーカー",     hp: 90,  atk: 33, def: 13, exp: 104 },
      { name: "覇バーサーカー",     hp: 145, atk: 48, def: 20, exp: 166 },
    ],
  },
  { name: "キラープラスター", hp: 35, atk: 15, def: 4,  exp: 58,  speed: 1,   tile: 8, kind: "humanoid", baseKind: "killplaster",   monLevel: 1, minFloor: 12, maxFloor: 45, subtype: "defhalf",
    levels: [
      { name: "キラープラスターII", hp: 56,  atk: 21, def: 7,  exp: 92  },
      { name: "キラープラスターΩ",  hp: 88,  atk: 30, def: 11, exp: 148 },
    ],
  },
  { name: "ガーディアン",  hp: 48,  atk: 13, def: 14, exp: 70,  speed: 1,   tile: 59, kind: "humanoid", baseKind: "guardian",      monLevel: 1, minFloor: 10, maxFloor: 10, subtype: "guardian", dungeons: ["beginner"] },
  { name: "氷竜",         hp: 65,  atk: 27, def: 10, exp: 125, speed: 1,   tile: 14, kind: "beast",    baseKind: "icedragon",     monLevel: 1, minFloor: 18, maxFloor: 50, elemWeak: "thunder",
    levels: [
  ...
  /* ===== 視界操作モンスター ===== */
  { name: "スターライト", hp: 55,  atk: 22, def: 8,  exp: 80,  speed: 1,   tile: 53, kind: "beast",   baseKind: "starlight",     monLevel: 1, minFloor: 15, maxFloor: 50, float: true,
  ...
  { name: "ダークネス",   hp: 65,  atk: 25, def: 10, exp: 95,  speed: 1,   tile: 52, kind: "beast",   baseKind: "darkness",      monLevel: 1, minFloor: 20, maxFloor: 50, float: true,
