...
export const MONS = [
  { name: "ネズミ",       hp: 7,   atk: 5,  def: 0,  exp: 3,   speed: 1,   tile: 6,  kind: "beast",    baseKind: "rat",          monLevel: 1, minFloor: 1,  maxFloor: 10, dungeonFloors: { beginner: { min: 1, max: 3 }, intermediate: { min: 1, max: 4 }, advanced: { min: 1, max: 3 } },
    levels: [
      { name: "殺人ネズミ",         hp: 11,  atk: 6,  def: 3,  exp: 5   },
      { name: "ものすごいネズミ",   hp: 18,  atk: 8,  def: 6,  exp: 8   },
    ],
  },
  { name: "バット",       hp: 8,   atk: 5,  def: 0,  exp: 4,   speed: 1,   tile: 103, kind: "beast",   baseKind: "bat",           monLevel: 1, minFloor: 1,  maxFloor: 9,  float: true, dungeonFloors: { beginner: { min: 1, max: 4 }, intermediate: { min: 1, max: 7 }, advanced: { min: 1, max: 4 } },
    levels: [
      { name: "青バット",               hp: 14,  atk: 8,  def: 2,  exp: 7   },
      { name: "ゴルァバット",           hp: 22,  atk: 11, def: 4,  exp: 11  },
    ],
  },
  ...
  { name: "マイナーダイミョウ", hp: 30,  atk: 17, def: 3,  exp: 42,  speed: 1,   tile: 39,  kind: "humanoid", baseKind: "itemblaster",  monLevel: 1, minFloor: 6,  maxFloor: 22, subtype: "itemblast", dungeonFloors: { beginner: null, intermediate: { min: 11, max: 16 }, advanced: { min: 3, max: 12 } },
    levels: [
      { name: "メジャーダイミョウ",     hp: 48,  atk: 23, def: 5,  exp: 68  },
      { name: "ミフネ",                 hp: 70,  atk: 29, def: 8,  exp: 98  },
    ],
  },
  { name: "盗投士",       hp: 28,  atk: 16, def: 3,  exp: 45,  speed: 1,   tile: 69, kind: "humanoid", baseKind: "stealthrower", monLevel: 1, minFloor: 8,  maxFloor: 24, subtype: "stealthrower", dungeonFloors: { beginner: null, intermediate: { min: 12, max: 17 }, advanced: { min: 5, max: 15 } },
    levels: [
      { name: "大盗投士",               hp: 46,  atk: 22, def: 5,  exp: 72  },
      { name: "覇盗投士",               hp: 67,  atk: 29, def: 8,  exp: 108 },
    ],
  },
  { name: "コボルド",     hp: 15,  atk: 8,  def: 2,  exp: 10,  speed: 1,   tile: 7,  kind: "humanoid", baseKind: "kobold",        monLevel: 1, minFloor: 2,  maxFloor: 13, dungeonFloors: { beginner: { min: 3, max: 6 }, intermediate: { min: 3, max: 9 }, advanced: { min: 1, max: 7 } },
    levels: [
      { name: "コボルド戦士",       hp: 26,  atk: 13, def: 7,  exp: 16  },
      { name: "コボルド族長",       hp: 40,  atk: 17, def: 11, exp: 25  },
    ],
  },
  { name: "ゴブリン",     hp: 23,  atk: 16, def: 5,  exp: 20,  speed: 1,   tile: 8,  kind: "humanoid", baseKind: "goblin",        monLevel: 1, minFloor: 3,  maxFloor: 16, dungeonFloors: { beginner: { min: 4, max: 7 }, intermediate: { min: 3, max: 10 }, advanced: { min: 1, max: 8 } },
    levels: [
      { name: "ゴブリン頭",         hp: 45,  atk: 22, def: 9,  exp: 32  },
      { name: "ゴブリン王",         hp: 68,  atk: 28, def: 15, exp: 50  },
    ],
  },
  { name: "インプ",       hp: 26,  atk: 18, def: 4,  exp: 28,  speed: 2,   tile: 53, kind: "beast",    baseKind: "imp",           monLevel: 1, minFloor: 3,  maxFloor: 17, float: true, dungeonFloors: { beginner: { min: 8, max: 10 }, intermediate: { min: 6, max: 12 }, advanced: { min: 3, max: 10 } },
    levels: [
      { name: "強インプ",           hp: 42,  atk: 23, def: 7,  exp: 45  },
      { name: "覇インプ",           hp: 65,  atk: 30, def: 11, exp: 70  },
    ],
  },
  { name: "スケルトン",   hp: 24,  atk: 19, def: 5,  exp: 25,  speed: 1,   tile: 9,  kind: "undead",   baseKind: "skeleton",      monLevel: 1, minFloor: 4,  maxFloor: 18, dungeonFloors: { beginner: { min: 6, max: 9 }, intermediate: { min: 4, max: 11 }, advanced: { min: 2, max: 10 } },
    levels: [
      { name: "強スケルトン",       hp: 39,  atk: 26, def: 9,  exp: 40  },
      { name: "アンデッドナイト",   hp: 61,  atk: 32, def: 13, exp: 62  },
    ],
  },
  { name: "フクマル",     hp: 11,  atk: 0,  def: 0,  exp: 50,  speed: 2,   tile: 70, kind: "beast",    baseKind: "runner",        monLevel: 1, minFloor: 5,  maxFloor: 30, subtype: "runner", dungeonFloors: { beginner: { min: 5, max: 8 }, intermediate: { min: 4, max: 18 }, advanced: { min: 3, max: 25 } },
    levels: [
      { name: "フクフクマル",       hp: 16,  atk: 0,  def: 0,  exp: 80  },
      { name: "コイトフクマル",     hp: 24,  atk: 0,  def: 0,  exp: 120 },
    ],
  },
  { name: "ゾンビ",       hp: 55,  atk: 24, def: 5,  exp: 45,  speed: 0.5, tile: 10, kind: "undead",   baseKind: "zombie",        monLevel: 1, minFloor: 6,  maxFloor: 19, elemWeak: "fire", dungeonFloors: { beginner: { min: 8, max: 10 }, intermediate: { min: 9, max: 15 }, advanced: { min: 5, max: 14 } },
    levels: [
      { name: "中ゾンビ",           hp: 85,  atk: 34, def: 12, exp: 72  },
      { name: "強ゾンビ",           hp: 130, atk: 42, def: 18, exp: 110 },
    ],
  },
  { name: "ワッカ",       hp: 24,  atk: 17, def: 2,  exp: 28,  speed: 1,   tile: 67, kind: "beast",    baseKind: "wokka",         monLevel: 1, minFloor: 6,  maxFloor: 18, subtype: "stonethrow", dungeonFloors: { beginner: { min: 8, max: 10 }, intermediate: { min: 9, max: 14 }, advanced: { min: 4, max: 13 } },
    levels: [
      { name: "ぷにぷにワッカ",     hp: 38,  atk: 24, def: 5,  exp: 45  },
      { name: "シン・ワッカ",       hp: 61,  atk: 32, def: 7,  exp: 72  },
    ],
  },
  { name: "分裂スライム", hp: 30,  atk: 14, def: 2,  exp: 32,  speed: 1,   tile: 77, kind: "beast",    baseKind: "slime",         monLevel: 1, minFloor: 7,  maxFloor: 20, elemWeak: "fire", subtype: "splitter", dungeonFloors: { beginner: { min: 7, max: 10 }, intermediate: { min: 9, max: 15 }, advanced: { min: 4, max: 13 } },
    levels: [
      { name: "緑分裂スライム",     hp: 47,  atk: 22, def: 5,  exp: 51  },
      { name: "赤分裂スライム",     hp: 74,  atk: 29, def: 7,  exp: 80  },
    ],
  },
  { name: "アーチャー",   hp: 30,  atk: 18, def: 3,  exp: 34,  speed: 1,   tile: 39, kind: "humanoid", baseKind: "archer",        monLevel: 1, minFloor: 8,  maxFloor: 21, subtype: "archer", dungeonFloors: { beginner: { min: 7, max: 10 }, intermediate: { min: 6, max: 12 }, advanced: { min: 3, max: 11 } },
    levels: [
      { name: "古参アーチャー",     hp: 47,  atk: 25, def: 7,  exp: 54  },
      { name: "弓の達人",           hp: 74,  atk: 32, def: 12, exp: 85  },
    ],
  },
  { name: "ウルフ",       hp: 27,  atk: 20, def: 2,  exp: 40,  speed: 2,   tile: 56, kind: "beast",    baseKind: "wolf",          monLevel: 1, minFloor: 9,  maxFloor: 22, dungeonFloors: { beginner: null, intermediate: { min: 11, max: 17 }, advanced: { min: 4, max: 14 } },
    levels: [
      { name: "強ウルフ",           hp: 43,  atk: 28, def: 6,  exp: 64  },
      { name: "フェンリル",         hp: 68,  atk: 36, def: 10, exp: 100 },
    ],
  },
  { name: "コソドロ",     hp: 16,  atk: 7,  def: 0,  exp: 35,  speed: 2,   tile: 69, kind: "humanoid", baseKind: "thief",         monLevel: 1, minFloor: 9,  maxFloor: 20, subtype: "thief", dungeonFloors: { beginner: null, intermediate: { min: 11, max: 16 }, advanced: { min: 4, max: 14 } },
    levels: [
      { name: "大盗賊",             hp: 27,  atk: 11, def: 2,  exp: 56  },
      { name: "怪盗",               hp: 43,  atk: 14, def: 3,  exp: 88  },
    ],
  },
  { name: "レプラコーン", hp: 20,  atk: 9,  def: 1,  exp: 38,  speed: 2,   tile: 109, kind: "humanoid", baseKind: "leprechaun",    monLevel: 1, minFloor: 11, maxFloor: 24, subtype: "goldthief", dungeonFloors: { beginner: null, intermediate: { min: 11, max: 17 }, advanced: { min: 4, max: 14 } },
    levels: [
      { name: "強レプラコーン",       hp: 33,  atk: 13, def: 3,  exp: 61  },
      { name: "覇レプラコーン",       hp: 52,  atk: 17, def: 5,  exp: 95  },
    ],
  },
  { name: "錆虫",         hp: 24,  atk: 13, def: 2,  exp: 40,  speed: 1,   tile: 75, kind: "beast",    baseKind: "rustbug",       monLevel: 1, minFloor: 10, maxFloor: 23, elemWeak: "thunder", subtype: "ruster", dungeonFloors: { beginner: null, intermediate: { min: 11, max: 17 }, advanced: { min: 5, max: 16 } },
    levels: [
      { name: "強錆虫",             hp: 39,  atk: 18, def: 5,  exp: 64  },
      { name: "覇錆虫",             hp: 61,  atk: 25, def: 7,  exp: 100 },
    ],
  },
  { name: "ウィザード",   hp: 24,  atk: 17, def: 3,  exp: 42,  speed: 1,   tile: 40, kind: "humanoid", baseKind: "wizard",        monLevel: 1, minFloor: 11, maxFloor: 24, subtype: "wanduser", wandEffect: "lightning", dungeonFloors: { intermediate: { min: 11, max: 17 }, advanced: { min: 5, max: 15 } },
    levels: [
      { name: "強ウィザード",       hp: 39,  atk: 24, def: 7,  exp: 67  },
      { name: "大魔導士",           hp: 61,  atk: 29, def: 12, exp: 105 },
    ],
  },
  { name: "ボムスライム", hp: 38,  atk: 14, def: 2,  exp: 55,  speed: 1,   tile: 77, kind: "beast",    baseKind: "bombslime",     monLevel: 1, minFloor: 11, maxFloor: 24, elemWeak: "fire", subtype: "deathbomb", dungeonFloors: { intermediate: { min: 13, max: 18 }, advanced: { min: 7, max: 17 } },
    levels: [
      { name: "強ボムスライム",     hp: 61,  atk: 22, def: 3,  exp: 88  },
      { name: "覇ボムスライム",     hp: 95,  atk: 29, def: 5,  exp: 138 },
    ],
  },
  { name: "ボルガ",       hp: 28,  atk: 12, def: 0,  exp: 60,  speed: 1,   tile: 8,  kind: "humanoid", baseKind: "bombgoblin",    monLevel: 1, minFloor: 12, maxFloor: 26, subtype: "kamikaze", dungeonFloors: { intermediate: { min: 13, max: 18 }, advanced: { min: 7, max: 18 } },
    levels: [
      { name: "ボルガ博士",         hp: 48,  atk: 18, def: 2,  exp: 96,  speed: 1 },
      { name: "頭の中にダイナマイト", hp: 75, atk: 24, def: 4,  exp: 150 },
    ],
  },
  { name: "水晶スライム", hp: 5,   atk: 18, def: 0,  exp: 50,  speed: 1,   tile: 77, kind: "beast",    baseKind: "crystalslime",  monLevel: 1, minFloor: 13, maxFloor: 26, elemWeak: "fire", fixedDamageOnly: true, dungeonFloors: { intermediate: { min: 13, max: 18 }, advanced: { min: 7, max: 18 } },
    levels: [
      { name: "強水晶スライム",     hp: 8,   atk: 25, def: 0,  exp: 80  },
      { name: "覇水晶スライム",     hp: 11,  atk: 32, def: 0,  exp: 125 },
    ],
  },
  { name: "ゴースト",     hp: 38,  atk: 18, def: 5,  exp: 45,  speed: 1,   tile: 68, kind: "undead",   baseKind: "rockspirit",    monLevel: 1, minFloor: 14, maxFloor: 28, wallWalker: true, dungeonFloors: { intermediate: { min: 13, max: 19 }, advanced: { min: 7, max: 20 } },
    levels: [
      { name: "ファントム",         hp: 61,  atk: 25, def: 9,  exp: 72  },
      { name: "ミラージュ",         hp: 95,  atk: 32, def: 13, exp: 113, speed: 2 },
    ],
  },
  { name: "オーク",       hp: 41,  atk: 22, def: 7,  exp: 48,  speed: 1,   tile: 11, kind: "humanoid", baseKind: "orc",           monLevel: 1, minFloor: 14, maxFloor: 26, dungeonFloors: { intermediate: { min: 13, max: 19 }, advanced: { min: 7, max: 18 } },
    levels: [
      { name: "オーク将",           hp: 65,  atk: 31, def: 12, exp: 77  },
      { name: "オーク王",           hp: 101, atk: 40, def: 16, exp: 120 },
    ],
  },
  { name: "ゼラチンキューブ", hp: 81, atk: 22, def: 5, exp: 70,  speed: 0.5, tile: 79, kind: "beast", baseKind: "gelcube",       monLevel: 1, minFloor: 15, maxFloor: 50, elemWeak: "fire", dungeonFloors: { intermediate: { min: 15, max: 19 }, advanced: { min: 9, max: 20 } },
    levels: [
      { name: "強ゼラチンキューブ", hp: 130, atk: 31, def: 9,  exp: 112 },
      { name: "覇ゼラチンキューブ", hp: 203, atk: 40, def: 13, exp: 175 },
    ],
  },
  { name: "岩砕き",       hp: 68,  atk: 28, def: 7,  exp: 65,  speed: 0.5, tile: 76, kind: "beast",    baseKind: "walldigger",    monLevel: 1, minFloor: 16, maxFloor: 50, wallDigger: true, dungeonFloors: { intermediate: { min: 15, max: 19 }, advanced: { min: 9, max: 22 } },
    levels: [
      { name: "強岩砕き",           hp: 108, atk: 38, def: 12, exp: 104 },
      { name: "覇岩砕き",           hp: 169, atk: 50, def: 16, exp: 163 },
    ],
  },
  { name: "罠師",         hp: 34,  atk: 18, def: 3,  exp: 48,  speed: 1,   tile: 86, kind: "humanoid", baseKind: "trapmaster",    monLevel: 1, minFloor: 16, maxFloor: 50, subtype: "trapmaster", dungeonFloors: { intermediate: { min: 15, max: 19 }, advanced: { min: 9, max: 20 } },
    levels: [
      { name: "罠の達人",           hp: 54,  atk: 25, def: 7,  exp: 77  },
      { name: "罠の覇者",           hp: 85,  atk: 32, def: 12, exp: 120 },
    ],
  },
  { name: "大蛇",         hp: 47,  atk: 24, def: 5,  exp: 52,  speed: 1,   tile: 12, kind: "beast",    baseKind: "serpent",       monLevel: 1, minFloor: 17, maxFloor: 50, maxAttacks: 2, dungeonFloors: { intermediate: { min: 15, max: 19 }, advanced: { min: 9, max: 20 } },
    levels: [
      { name: "強大蛇",             hp: 76,  atk: 32, def: 9,  exp: 83  },
      { name: "覇大蛇",             hp: 119, atk: 42, def: 13, exp: 130 },
    ],
  },
  { name: "ゴールドタイガー", hp: 38,  atk: 20, def: 5,  exp: 55,  speed: 1,   tile: 39, kind: "humanoid", baseKind: "trapthrower",   monLevel: 1, minFloor: 18, maxFloor: 50, subtype: "trapthrower", dungeonFloors: { intermediate: { min: 17, max: 20 }, advanced: { min: 11, max: 22 } },
    levels: [
      { name: "ずっと見てタイガー", hp: 61,  atk: 28, def: 9,  exp: 88  },
      { name: "よく頑張っタイガー", hp: 95,  atk: 36, def: 13, exp: 138 },
    ],
  },
  { name: "呪術師",       hp: 34,  atk: 17, def: 5,  exp: 55,  speed: 1,   tile: 44, kind: "humanoid", baseKind: "witchdoc",      monLevel: 1, minFloor: 18, maxFloor: 50, subtype: "wanduser", wandEffect: "curse_wand", dungeonFloors: { intermediate: { min: 17, max: 20 }, advanced: { min: 11, max: 22 } },
    levels: [
      { name: "強呪術師",           hp: 54,  atk: 24, def: 9,  exp: 88  },
      { name: "大呪術師",           hp: 85,  atk: 29, def: 13, exp: 138 },
    ],
  },
  { name: "解装士",       hp: 38,  atk: 20, def: 5,  exp: 58,  speed: 1,   tile: 59, kind: "humanoid", baseKind: "disarmer",      monLevel: 1, minFloor: 19, maxFloor: 50, subtype: "disarmer", dungeonFloors: { intermediate: { min: 18, max: 20 }, advanced: { min: 12, max: 24 } },
    levels: [
      { name: "強解装士",           hp: 61,  atk: 28, def: 9,  exp: 93  },
      { name: "覇解装士",           hp: 95,  atk: 36, def: 13, exp: 145 },
    ],
  },
  { name: "かいりきベア", hp: 43,  atk: 22, def: 6,  exp: 62,  speed: 1,   tile: 11, kind: "humanoid", baseKind: "monsterthrow",  monLevel: 1, minFloor: 20, maxFloor: 50, subtype: "monsterthrow", dungeonFloors: { intermediate: { min: 18, max: 20 }, advanced: { min: 12, max: 24 } },
    levels: [
      { name: "かいりきベア・セブン", hp: 69,  atk: 31, def: 10, exp: 99  },
      { name: "かいりきベア・イレブン", hp: 108, atk: 40, def: 14, exp: 155 },
    ],
  },
  { name: "シャーマン",   hp: 41,  atk: 17, def: 5,  exp: 60,  speed: 1,   tile: 55, kind: "humanoid", baseKind: "shaman",        monLevel: 1, minFloor: 21, maxFloor: 50, subtype: "supporter", dungeonFloors: { intermediate: { min: 17, max: 20 }, advanced: { min: 11, max: 22 } },
    levels: [
      { name: "強シャーマン",       hp: 65,  atk: 24, def: 9,  exp: 96  },
      { name: "大シャーマン",       hp: 101, atk: 29, def: 13, exp: 150 },
    ],
  },
  { name: "合成獣",       hp: 54,  atk: 20, def: 5,  exp: 80,  speed: 0.5, tile: 80, kind: "beast",    baseKind: "synthmonster",  monLevel: 1, minFloor: 21, maxFloor: 50, dungeonFloors: { advanced: { min: 13, max: 24 } },
    levels: [
      { name: "強合成獣",           hp: 86,  atk: 29, def: 9,  exp: 128 },
      { name: "覇合成獣",           hp: 135, atk: 38, def: 13, exp: 200 },
    ],
  },
  { name: "バリア蟹",     hp: 43,  atk: 20, def: 3,  exp: 68,  speed: 1,   tile: 54, kind: "humanoid", baseKind: "barriermage",   monLevel: 1, minFloor: 22, maxFloor: 50, barrier: 1, dungeonFloors: { intermediate: { min: 18, max: 20 }, advanced: { min: 13, max: 26 } },
    levels: [
      { name: "シールド蟹",         hp: 69,  atk: 28, def: 6,  exp: 109, barrier: 2 },
      { name: "なんでも無効蟹",     hp: 108, atk: 36, def: 9,  exp: 170, barrier: 3 },
    ],
  },
  { name: "ウィンドメイジ", hp: 38, atk: 20, def: 5, exp: 65,  speed: 1,   tile: 54, kind: "humanoid", baseKind: "windmage",     monLevel: 1, minFloor: 23, maxFloor: 50, subtype: "wanduser", wandEffect: "blowback_wand", dungeonFloors: { intermediate: { min: 18, max: 20 }, advanced: { min: 14, max: 26 } },
    levels: [
      { name: "強ウィンドメイジ",   hp: 61,  atk: 28, def: 9,  exp: 104 },
      { name: "風の覇者",           hp: 95,  atk: 36, def: 13, exp: 163 },
    ],
  },
  { name: "混乱術師",     hp: 41,  atk: 20, def: 5,  exp: 72,  speed: 1,   tile: 81, kind: "humanoid", baseKind: "confusemage",   monLevel: 1, minFloor: 23, maxFloor: 50, subtype: "wanduser", wandEffect: "confuse_wand", dungeonFloors: { intermediate: { min: 17, max: 20 }, advanced: { min: 14, max: 26 } },
    levels: [
      { name: "強混乱術師",         hp: 65,  atk: 28, def: 9,  exp: 115 },
      { name: "大混乱術師",         hp: 101, atk: 35, def: 13, exp: 180 },
    ],
  },
  { name: "引きダコ",     hp: 61,  atk: 24, def: 6,  exp: 75,  speed: 1,   tile: 78, kind: "beast",    baseKind: "puller",        monLevel: 1, minFloor: 24, maxFloor: 50, subtype: "puller", dungeonFloors: { intermediate: { min: 18, max: 20 }, advanced: { min: 12, max: 24 } },
    levels: [
      { name: "強引きダコ",         hp: 97,  atk: 32, def: 10, exp: 120 },
      { name: "覇引きダコ",         hp: 153, atk: 43, def: 14, exp: 188 },
    ],
  },
  { name: "眠り術師",     hp: 43,  atk: 22, def: 6,  exp: 80,  speed: 1,   tile: 82, kind: "humanoid", baseKind: "sleepmage",     monLevel: 1, minFloor: 25, maxFloor: 50, subtype: "wanduser", wandEffect: "sleep_wand", dungeonFloors: { intermediate: { min: 19, max: 20 }, advanced: { min: 13, max: 25 } },
    levels: [
      { name: "強眠り術師",         hp: 69,  atk: 29, def: 10, exp: 128 },
      { name: "大眠り術師",         hp: 108, atk: 36, def: 16, exp: 200 },
    ],
  },
  { name: "トロル",       hp: 68,  atk: 29, def: 9,  exp: 75,  speed: 1,   tile: 13, kind: "humanoid", baseKind: "troll",         monLevel: 1, minFloor: 25, maxFloor: 50, dungeonFloors: { intermediate: { min: 19, max: 20 }, advanced: { min: 13, max: 25 } },
    levels: [
      { name: "強トロル",           hp: 108, atk: 40, def: 13, exp: 120 },
      { name: "覇トロル",           hp: 169, atk: 53, def: 17, exp: 188 },
    ],
  },
  { name: "火ダルマ",     hp: 74,  atk: 36, def: 6,  exp: 110, speed: 1,   tile: 61, kind: "beast",    baseKind: "firedemon",     monLevel: 1, minFloor: 25, maxFloor: 50, float: true, dungeonFloors: { intermediate: { min: 19, max: 20 }, advanced: { min: 14, max: 26 } },
    levels: [
      { name: "獄炎ダルマ",         hp: 119, atk: 50, def: 10, exp: 176 },
      { name: "煉獄ダルマ",         hp: 189, atk: 67, def: 14, exp: 275 },
    ],
  },
  { name: "転移術師",     hp: 47,  atk: 24, def: 6,  exp: 90,  speed: 1,   tile: 83, kind: "humanoid", baseKind: "warpmage",      monLevel: 1, minFloor: 26, maxFloor: 50, subtype: "wanduser", wandEffect: "teleport_wand", dungeonFloors: { advanced: { min: 17, max: 28 } },
    levels: [
      { name: "強転移術師",         hp: 76,  atk: 31, def: 10, exp: 144 },
      { name: "大転移術師",         hp: 117, atk: 38, def: 16, exp: 225 },
    ],
  },
  { name: "ガーゴイル",   hp: 88,  atk: 32, def: 16, exp: 90,  speed: 0.5, tile: 52, kind: "undead",   baseKind: "gargoyle",      monLevel: 1, minFloor: 26, maxFloor: 50, float: true, dungeonFloors: { advanced: { min: 17, max: 28 } },
    levels: [
      { name: "強ガーゴイル",       hp: 140, atk: 46, def: 21, exp: 144 },
      { name: "覇ガーゴイル",       hp: 220, atk: 58, def: 27, exp: 225 },
    ],
  },
  { name: "ヴァンパイア", hp: 81,  atk: 32, def: 10, exp: 92,  speed: 2,   tile: 15, kind: "undead",   baseKind: "vampire",       monLevel: 1, minFloor: 26, maxFloor: 50, maxAttacks: 2, float: true, dungeonFloors: { advanced: { min: 18, max: 28 } },
    levels: [
      { name: "強ヴァンパイア",     hp: 130, atk: 46, def: 14, exp: 147 },
      { name: "ヴァンパイア卿",     hp: 203, atk: 58, def: 19, exp: 230 },
    ],
  },
  { name: "ドラゴン",     hp: 122, atk: 43, def: 14, exp: 140, speed: 1,   tile: 14, kind: "dragon",   baseKind: "dragon",        monLevel: 1, minFloor: 27, maxFloor: 50, elemWeak: "ice", dungeonFloors: { advanced: { min: 20, max: 30 } },
    levels: [
      { name: "レッドドラゴン",       hp: 194, atk: 61, def: 19, exp: 224 },
      { name: "エンシェントドラゴン", hp: 304, atk: 78, def: 23, exp: 350 },
    ],
  },
  { name: "ゴーレム",     hp: 135, atk: 36, def: 23, exp: 115, speed: 0.5, tile: 57, kind: "beast",    baseKind: "golem",         monLevel: 1, minFloor: 27, maxFloor: 50, elemWeak: "thunder", dungeonFloors: { advanced: { min: 21, max: 30 } },
    levels: [
      { name: "強ゴーレム",         hp: 216, atk: 50, def: 28, exp: 184 },
      { name: "覇ゴーレム",         hp: 338, atk: 65, def: 34, exp: 288 },
    ],
  },
  { name: "デーモン",     hp: 108, atk: 50, def: 13, exp: 160, speed: 2,   tile: 58, kind: "beast",    baseKind: "daemon",        monLevel: 1, minFloor: 27, maxFloor: 50, maxAttacks: 3, float: true, dungeonFloors: { advanced: { min: 23, max: 30 } },
    levels: [
  ...
  /* ===== 新型モンスター4種 ===== */
  { name: "からめ鬼",    hp: 55,  atk: 22, def: 10, exp: 55,  speed: 1,   tile: 108, kind: "beast",    baseKind: "grabber",       monLevel: 1, minFloor: 5,  maxFloor: 15, subtype: "grabber", dungeonFloors: { beginner: { min: 8, max: 10 }, intermediate: { min: 6, max: 13 }, advanced: { min: 3, max: 12 } },
    levels: [
      { name: "強からめ鬼",         hp: 88,  atk: 32, def: 14, exp: 88  },
      { name: "覇からめ鬼",         hp: 138, atk: 43, def: 19, exp: 138 },
    ],
  },
  { name: "突進角獣",    hp: 62,  atk: 26, def: 8,  exp: 62,  speed: 1,   tile: 56, kind: "beast",    baseKind: "charger",       monLevel: 1, minFloor: 10, maxFloor: 35, subtype: "charger", dungeonFloors: { beginner: null, intermediate: { min: 11, max: 18 }, advanced: { min: 5, max: 18 } },
    levels: [
      { name: "強突進角獣",         hp: 99,  atk: 38, def: 12, exp: 99  },
      { name: "覇突進角獣",         hp: 155, atk: 53, def: 16, exp: 155 },
    ],
  },
  { name: "ほっちもぺ",   hp: 68, atk: 24, def: 18, exp: 70, speed: 1,   tile: 57, kind: "beast",   baseKind: "reflector",     monLevel: 1, minFloor: 12, maxFloor: 45, subtype: "reflector", dungeonFloors: { intermediate: { min: 12, max: 18 }, advanced: { min: 6, max: 18 } },
    levels: [
      { name: "ほっちんもっぺ",     hp: 109, atk: 35, def: 24, exp: 112 },
      { name: "むちちむち",         hp: 170, atk: 46, def: 31, exp: 175 },
    ],
  },
  { name: "ハンマーオーガ", hp: 75, atk: 36, def: 9,  exp: 80,  speed: 1,   tile: 13, kind: "humanoid", baseKind: "knocker",      monLevel: 1, minFloor: 15, maxFloor: 50, subtype: "knocker", dungeonFloors: { intermediate: { min: 15, max: 19 }, advanced: { min: 9, max: 22 } },
    levels: [
      { name: "強ハンマーオーガ",   hp: 120, atk: 52, def: 13, exp: 128 },
      { name: "覇ハンマーオーガ",   hp: 188, atk: 67, def: 17, exp: 200 },
    ],
  },
  { name: "魔法反射師",   hp: 38,  atk: 19, def: 8,  exp: 75,  speed: 1,   tile: 55, kind: "humanoid", baseKind: "magicreflector", monLevel: 1, minFloor: 13, maxFloor: 50, subtype: "magicreflect", dungeonFloors: { intermediate: { min: 16, max: 20 }, advanced: { min: 10, max: 22 } },
    levels: [
      { name: "強魔法反射師",       hp: 61,  atk: 26, def: 13, exp: 120 },
      { name: "覇魔法反射師",       hp: 95,  atk: 35, def: 18, exp: 188 },
    ],
  },
  { name: "薬師",         hp: 30,  atk: 16, def: 3,  exp: 48,  speed: 1,   tile: 44, kind: "humanoid", baseKind: "potionthrower", monLevel: 1, minFloor: 10, maxFloor: 50, subtype: "potionthrow", dungeonFloors: { beginner: null, intermediate: { min: 11, max: 18 }, advanced: { min: 5, max: 18 } },
    levels: [
      { name: "ポーションメーカー", hp: 48,  atk: 22, def: 6,  exp: 76  },
      { name: "ポーションマスター", hp: 75,  atk: 29, def: 10, exp: 120 },
    ],
  },
  { name: "バーサーカー", hp: 55,  atk: 26, def: 8,  exp: 65,  speed: 1,   tile: 13, kind: "humanoid", baseKind: "berserker",     monLevel: 1, minFloor: 12, maxFloor: 45, subtype: "berserker", dungeonFloors: { advanced: { min: 8, max: 20 } },
    levels: [
      { name: "バーサーカー2",      hp: 90,  atk: 40, def: 13, exp: 104 },
      { name: "バーサーカー99",     hp: 145, atk: 58, def: 20, exp: 166 },
    ],
  },
  { name: "ルカチュウ", hp: 35, atk: 18, def: 4,  exp: 58,  speed: 1,   tile: 8, kind: "humanoid", baseKind: "killplaster",   monLevel: 1, minFloor: 12, maxFloor: 45, subtype: "defhalf", magicImmune: true, dungeonFloors: { advanced: { min: 8, max: 20 } },
    levels: [
  ...
  { name: "氷竜",         hp: 65,  atk: 32, def: 10, exp: 125, speed: 1,   tile: 14, kind: "beast",    baseKind: "icedragon",     monLevel: 1, minFloor: 18, maxFloor: 50, elemWeak: "thunder", dungeonFloors: { advanced: { min: 19, max: 30 } },
    levels: [
      { name: "ブルードラゴン",             hp: 105, atk: 44, def: 16, exp: 200 },
      { name: "ブルードラゴン 天界の七竜", hp: 168, atk: 58, def: 22, exp: 320 },
    ],
  },
  { name: "わてり",       hp: 40,  atk: 19, def: 6,  exp: 48,  speed: 1,   tile: 93, kind: "beast",    baseKind: "wateri",        monLevel: 1, minFloor: 6,  maxFloor: 20, elemWeak: "thunder", waterOnly: true, subtype: "watergunner", dungeonFloors: { beginner: null, intermediate: { min: 14, max: 19 }, advanced: { min: 10, max: 22 } },
    levels: [
  ...
  /* ===== 視界操作モンスター ===== */
  { name: "スターライト", hp: 55,  atk: 26, def: 8,  exp: 80,  speed: 1,   tile: 53, kind: "beast",   baseKind: "starlight",     monLevel: 1, minFloor: 15, maxFloor: 50, float: true, dungeonFloors: { advanced: { min: 15, max: 27 } },
  ...
  { name: "ダークネス",   hp: 65,  atk: 30, def: 10, exp: 95,  speed: 1,   tile: 52, kind: "beast",   baseKind: "darkness",      monLevel: 1, minFloor: 20, maxFloor: 50, float: true, dungeonFloors: { advanced: { min: 19, max: 30 } },
