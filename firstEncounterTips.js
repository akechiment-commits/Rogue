...
export const FIRST_ENCOUNTER_TIPS = Object.freeze({
  ...
  gacha_machine: { title: "ガチャマシーン", trigger: "足元・正面・フロア一覧からガチャマシーンを調べる", text: ["1000Gを払うと、通常は普通のアイテム、3%で少しレアな景品が1個出る。", "炎・雷・氷・穴掘り・軟化などの破壊系の杖、ダメージ系の薬、爆発で壊れて景品を1個落とす。店内の台を壊すか店外へ出すと泥棒扱いになる。"] },
